...
define(function(require,exports,module){
    ...
    (function(){
        ...
        $('body').on('change', '.order-state', function(){
            ...
            $.ajax({
                ...
                url: '/mall/admin/orders/'+orderId+'.do',
                async: false,
                dataType: "json",
                traditional :true,
    ...
    function updateExpress(orderId, goodsId, requestData){
        Common.getPostData('/mall/admin/orders/'+orderId+'/goods/'+goodsId+'.do', requestData, function(resp){
    ...
    function getOrders(page){
        ...
        Common.getData("/mall/admin/orders.do", requestParam, function(resp){
            paginator(resp);
