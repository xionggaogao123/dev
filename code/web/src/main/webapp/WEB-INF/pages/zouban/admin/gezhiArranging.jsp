                ...
                <ul>
                    ...
                    <c:choose>
                        <c:when test="${mode=='zhuZhouIndex'}">
                            <li class="Rclass" style="display: none;" id="Rclass"><a href="javascript:;">走班课程设置</a></li>
                            <li id="Xclass" style="display: none"><a href="javascript:;" >小走班</a></li>
                            <li id="Pclass" style="display: none;"><a href="javascript:;">体育课设置</a></li>
                        </c:when>
                        <c:otherwise>
                            <li class="Rclass" id="Rclass"><a href="javascript:;">走班课程设置</a></li>
                            <li id="Xclass" style="display: none"><a href="javascript:;" >小走班</a></li>
                            <li id="Pclass"><a href="javascript:;">体育课设置</a></li>
                        </c:otherwise>
                    </c:choose>

                    <li id="Nclass"><a href="javascript:;">非走班课程设置</a></li>
                    <li id="Oclass" style="display: none"><a href="javascript:;">其他课程</a></li>
            ...
            <div id="contentt">
                ...
                <div class="tab-timetable" id="tab-timetable">
                    <dl id="courseConfShow">
                        ...
                        <dd>--%>
                            ...
                            <c:choose>
                            <c:when test="${mode=='zhuZhouIndex'}">
                                <button id="confSave" style="margin-left:200px">保存</button>
                            <button id="arrangeInterest" style="  margin-left: 10px;width: 100px;">填充兴趣班</button>
                            </c:when>
                                <c:otherwise>
                                            ...
                                            {{?value2.xIndex==value1 && value2.yIndex==index+1}}
                                                ...
                                                {{??}}
                                                    {{?value2.groupStudy.length>0 && value2.personEvent.length>0}}
                                                        ...
                                                        <em class="arranging-GR">个人<i>({{=value2.personEvent.length}})</i></em>
                                                    {{??value2.groupStudy.length>0 }}
                                                        <em class="arranging-JY2">教研<i>({{=value2.groupStudy.length}})</i></em>
                                                    {{??value2.personEvent.length>0}}
                                                        <em class="arranging-GR2">个人<i>({{=value2.personEvent.length}})</i></em>
                                                    {{?}}
                                                {{?}}
                                            {{?}}
                                        {{~}}
                ...
                <div class="tab-Xclass" id="tab-Pclass">
                    <dl>
                        <dd>
                            <em>年级:${gradeName}</em>
                            <%--<button id="clearPhy" style="width: 125px;">清除已排体育课程</button>--%>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            {{~it.data.conf.classDays:value1:index1}}
                                                ...
                                                {{?value2.xIndex==value1 && value2.yIndex==index+1}}
                                                    {{?value2.courseIdList.length==0}}
                                                    <td class="Nclass-main-ZB ZB_table_base Nclass-PE-td-Empty" x="{{=value1}}" y="{{=index+1}}">
                                                    {{??}}
                                                    <td class="Nclass-main-ZB ZB_table_base Nclass-PE-td-Full" x="{{=value1}}" y="{{=index+1}}">
                                                    {{?}}
                                                        {{=value2.name}}
                                                        <!--===========弹出框=============-->
                                                        {{?value2.courseIdList.length>0}}
                                ...
                                <div class="Nclass-main-right">
                                    ...
                                    <script type="application/template" id="tableTempJs4">
                                        ...
                                        <tr>
                                            ...
                                            {{??value2.type==3 || value2.type==4 ||value2.type==6}}
                                            <td class="Nclass-main-Gray Nclass-main-PE ZB_table_base" x="{{=value1}}" y="{{=index+1}}">
                                                ...
                                                {{??value2.gs.length>0}}
                                                    <i style="color: #fd2b2b;">[教研]</i><br>{{?value2.type==4}}体育走班{{?}}
                                                    <div class="Nclass-ZB-SJ">
                                                        <div class="inner"></div>
                                                    </div>
                                                    <div class="Nclass-ZB-SJJ">
    ...
    <div class="gring-CUR">
        ...
        <dl>
            ...
            <dd id="subjectListShow">
                <%--<button>语文</button><button>数学</button><button>英语</button><button>化学</button><button>生物</button>
                <button>历史</button><button>地理</button><button>政治</button>--%>
            </dd>
            ...
            <dd>
                <em>名称</em>
                <%--<textarea style="border:1px solid #959595;" class="teacherEvent"></textarea>--%>
                <input style="border:1px solid #959595;width: 243px;height: 32px;" class="teacherEvent">
            </dd>
            <dd>
                <em>学科</em>
...
<script>
    seajs.use('/static_new/js/modules/zouban/0.1.0/admin/gezhiArranging.js');
</script>
</body>
</html>