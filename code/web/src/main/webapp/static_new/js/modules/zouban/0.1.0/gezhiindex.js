...
define(['doT', 'common', 'jquery','rome','initPaginator'], function (require, exports, module) {
    ...
    $(document).ready(function () {
        ...
        $("body").on("click","#step01",function(){
            ...
            $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=1",'_self');
        });
        ...
        $("body").on("click","#step03",function(){
            ...
            window.open('../zouban/gezhiClassrule.do?version=58&term='+ encodeURI(encodeURI($('#termShow').val()))+'&gid='+
            $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=1",'_self');
        });
        $("body").on("click","#step06",function(){
            ...
            window.open('../paike/gezhipaike.do?version=58&term='+ encodeURI(encodeURI($('#termShow').val()))+'&gid='+
            $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=1",'_self')
        });
        $("body").on("click","#viewTable0",function(){
            ...
            +'&gid='+ $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&pub="+published+"&mode=1","_self");
        });
        $("body").on("click","#viewTable1",function(){
            ...
            +'&gid='+ $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=1","_self");
        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.ste<getNowFormatDate())
                        {
                            ...
                            encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=1",'_self');
                        }
                    }
                });
            }
        ...
        $(".gotoJinyuan").click(function(){
            window.open('../paike/changZhengIndex.do?version=58&term=&gradeId=','_self');
        })
    });
    function getNowFormatDate() {
        ...
        var currentdate = term + seperator1 + month + seperator1 + strDate
    ...
    zoubanindex.showProgress=function()
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".v1").find("div").attr("state",0);
                $(".v2").find("div").attr("state",0);
                $(".v3").find("div").attr("state",0);
                $(".v6").find("div").attr("state",0);
                $(".v7").find("div").attr("state",0);
                $(".v8").find("div").attr("state",0);
    ...
    $(document).ready(function () {
        ...
        $("body").on("click", ".tab-edit", function () {//打开修改
            ...
            //$('#classlist2').val($(this).parent().attr("cid"));
            canSend = true;
            $(".bg").show();
            $(".error-span").hide();
        });
