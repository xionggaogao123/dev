                        ...
                        <dd>
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/docflow/documentList.do?type=0&index=5&version=1"  class="newPage-right-pagevieww" style="display:block">
                                ...
                                <c:otherwise>
                                    <a href="javascript:;"  class="newPage-right-pagevieww" style="display:block">
