                ...
                <div class="newPage-right">
                    <dl>
                        <dd>
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/growth/list.do?index=6" class="newPage-right-pageview"  style="display:block;">
                                ...
                                <c:when test="${roles:isStudent(sessionValue.userRole)}">
                                    <a href="/registration/list.do?index=6"  class="newPage-right-pageview" style="display:block;">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-15.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="javascript:;"  class="newPage-right-pageview" style="display:block;">
