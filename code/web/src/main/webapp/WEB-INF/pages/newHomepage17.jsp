        ...
        <dl>
            ...
            <dd>
                <div class="newPage-left">
                    ...
                    <a target="_blank" href="/user/gomall.do" class="newPage-left-SC newPage-shadow">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="javascript:;"  class="newPage-right-pagevieww"  style="display:none;">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-14-H.png" style="display:none;">
                                    </a>
