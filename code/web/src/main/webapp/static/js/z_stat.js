(function () {
    ...
    var h = document, d = window, f = encodeURIComponent, k = decodeURIComponent, p = unescape, q = escape;
    l.prototype = {ia: function () {
        try {
            this.R(), this.G(), this.fa(), this.D(), this.l(), this.da(), this.ca(), this.ga(), this.i(),
                this.ba(), this.ea(), this.ha(), this.$(), this.Y(), this.aa(), this.na(), d[this.p] = d[this.p] || {}, this.Z("_cnzz_CV")
        } catch (a) {
            g(a, "i failed")
        }
    }, la: function () {
        ...
        try {
            if ("undefined" === typeof d._cz_account || d._cz_account === this.c) {
                ...
                if ("[object Array]" === {}.toString.call(d._czc))for (var a = d._czc, c = 0, b = a.length; c < b; c++)this.w(a[c]);
                this.la()
            }
        } catch (e) {
            g(e, "pP failed")
        ...
        try {
            var a = this.r(this.C), c, b;
            this.a.b = {};
            if (a)for (var e = a.split("&"), a = 0; a < e.length; a++)b = k(e[a]), c = b.split("|"),
                this.a.b[k(c[0])] = {}, this.a.b[k(c[0])].P = k(c[1]), this.a.b[k(c[0])].f = k(c[2])
        } catch (d) {
            g(d, "gCV failed")
        }
    }, S: function () {
        ...
        try {
            return this.a.m = d.navigator.systemLanguage || d.navigator.language, this.a.m = this.a.m.toLowerCase(), this.a.m
        } catch (a) {
            g(a, "gL failed")
        }
    }, ea: function () {
        try {
            return this.a.N =
                    d.screen.width && d.screen.height ? d.screen.width + "x" + d.screen.height : "0x0", this.a.N
        } catch (a) {
            g(a, "gS failed")
        }
    }, l: function () {
        ...
        try {
            return this.a.n =
                this.g("rtime"), null === this.a.n && (this.a.n = 0), 0 < this.F() && 432E5 < (new Date).getTime() - this.F() && (this.a.n++, this.a.Q = (new Date).getTime()), this.a.n
        } catch (a) {
            g(a, "gRVT failed")
        }
    }, ga: function () {
        ...
        try {
            return this.a.h =
                this.g("cnzz_eid") || "none"
        } catch (a) {
            g(a, "gC failed")
        }
    }, pa: function () {
        try {
            var a = "http://c.cnzz.com/core.php?", c = [];
        ...
        try {
            ...
            var c = h.cookie.indexOf(a),
                b = "";
            if (-1 < c) {
                var e = h.cookie.indexOf(";", c);
                -1 === e && (e = h.cookie.length);
        ...
        try {
            var a = this.q, c = {}, b = this.r(this.q);
        ...
        try {
            var a = this.q + "=", c = [], b = new Date;
            b.setTime(b.getTime() + 157248E5);
            if (1E8 < this.c) {
                if ("none" !== this.a.h)c.push(f(this.a.h)); else {
            ...
            } else"none" !== this.a.h ? c.push("cnzz_eid=" + f(this.a.h)) : (e = Math.floor(2147483648 * Math.random()) + "-" + this.o + "-" + this.A(this.i()), c.push("cnzz_eid=" + f(e))), c.push("ntime=" + this.o), 0 < c.length ? (a += f(c.join("&")), a += "; expires=" + b.toUTCString(), a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString();
            h.cookie = a
        } catch (d) {
            g(d, "sS failed")
        }
        ...
        try {
            for (var c = a.length, b = "", d = 0; d < c; d++)a[d] && (b += p(a[d]));
        ...
        try {
            ...
            a.push("id=" + f(this.c));
            this.a.e || "" ===
                this.a.e ? a.push("r=" + f(this.a.e)) : a.push("r=" + f(this.a.oa));
            ...
            a.push("h=1");
            var c = a.join("&");
            "[object String]" === {}.toString.call(this.k) ?
                this.j(["http://ei.cnzz.com/stat.htm?" + c]) : (this.I && this.j(["http://" + this.I + "/stat.htm?" + c]), this.M && this.j(["http://" + this.M + "/stat.htm?" + c]))
        } catch (b) {
            g(b, "sD failed")
        }
    }, ja: function (a) {
        ...
        try {
            for (var c = a.length, b = null, e = 0; e < c; e++)a[e] && (b = "cnzz_image_" + Math.floor(2147483648 * Math.random()), d[b] = new Image, d[b].T = b, d[b].onload = d[b].onerror = d[b].onabort = function () {
                try {
