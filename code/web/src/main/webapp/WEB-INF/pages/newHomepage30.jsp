        ...
        <div class="newPage-right">
          <dl>
            <dd>
              ...
              <!--=====================微课超市=========================-->
              <a id="ct_7_1" href="/emarket?index=8&version=1" class="pageview-IV newPage-right-pagevieww newPageHover">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-17-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_7_2" href="/emarket?index=8&version=1" class="newPage-right-pagevieww">
              ...
              <a href="/myclass/tointerestclass?index=10" class="newPage-right-pageview newPage-right-none">
              ...
              <a href="/business/fieryactivitylist.do?index=11" class="newPage-right-pageview newPage-right-none">
              ...
              <a href="/chat?index=12" class="newPage-right-pagevieww newPage-right-none">
              ...
              <a href="javascript:;" class="newPage-right-pagevieww newPage-right-none">
              ...
              <a href="/schoolSecurity/schoolSecurityPage.do?index=14" class="newPage-right-pagevieww newPage-right-none">
              ...
              <a href="/myschool/managesubject?index=18&version=1&tag=1" class="newPage-right-pagevieww newPage-right-none">
              ...
              <a href="/mobile" class="newPage-right-pagevieww newPage-right-none">
