 ...
 * role              角色                rol     0 不明     5 学生   6 老师   7 家长  8 助教  9 内务
 * money             是否付款            mon     0 未付款    1 付款  （针对后台添加的用于退款标识）
 * price             购买价格            pri
...
public class ClassOrderEntry extends BaseDBObject {
    ...
    public ClassOrderEntry(
        ...
        BasicDBObject dbObject=new BasicDBObject()
                ...
                .append("cnp", function)
                .append("typ", type)
                .append("rol", Constant.ZERO)
                .append("mon", Constant.ONE)
    ...
    public int getMoney(){
        return getSimpleIntegerValueDef("mon",1);
    }
    ...
    public int getRole(){
        return getSimpleIntegerValueDef("rol",0);
    }
