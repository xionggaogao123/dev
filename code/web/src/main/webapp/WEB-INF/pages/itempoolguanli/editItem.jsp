...
<div id="content" class="clearfix">
    ...
    <div class="col-right">
        ...
        <h3 class="add-head">编辑题目</h3>
        <input id="itemId" type="hidden" value="${itemDTO.id}">
        <input id="itemType" type="hidden" value="${itemDTO.type}">
        <input id="itemLevel" type="hidden" value="${itemDTO.intLevel}">
        <input id="itemScore" type="hidden" value="${itemDTO.score}">
        <input id="itemTitle" type="hidden" value="${itemDTO.item}">
        <input id="itemParse" type="hidden" value="${itemDTO.parse}">
        <input id="itemAnswer" type="hidden" value="${itemDTO.answer}">
        <input id="answerNum" type="hidden" value="${itemDTO.answerNum}">
        ...
        <div class="add-ziyuan">
            ...
            <div class="form-col">
                ...
                <div class="form-main uploader-info">
                    ...
                    <div class="btn-list">
                        <button style='cursor:pointer' type="button" id="save">保存</button>
