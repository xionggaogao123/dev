...
<head>
  ...
  <style>
    ...
    .tongji1 .fangwen .zhexian1{
        height:320px;
        width:970px;
    }
    .tongji3 .fangwen .zhexian2 {
        width: 970px;
        height: 300px;
    }
    .tongji2 .fangwen .zhexian2 {
        width: 970px;
        height: 300px;
    }
    .tongji2 .fangwen .touxiang .bot {
        margin-left: 68px;
    }
    .tongji1 .fangwen .zhexian2{
        height:250px;
        width:970px;
    }
    .tongji1 .fangwen  .zhexian2_2{
        width:650px;
        height:230px;
        float: right;
        margin-right: 20px;
    ...
    .tongji1 .fangwen .zhexian2_1 {
        width: 230px;
        height: 230px;
        float: left;
    }
    .tongji1 .fangwen .touxiang .bot {
        margin-right: 73px;
    }
  </style>
</head>
  ...
  <div style="width:1000px; margin: 0 auto; overflow: hidden; ">
    ...
    <div class="right" style="width: 1000px;">
      <div class="right_top">
        ...
        <div style="cursor:pointer; margin-bottom: 10px;"><a href="/manageCount/countMain.do?a=10000">&nbsp;&nbsp;&nbsp;&nbsp;返回&gt;</a></div>
        <div class="select">
