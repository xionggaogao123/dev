...
define(['doT', 'common', 'jquery','rome','initPaginator'], function (require, exports, module) {
    ...
    $(document).ready(function () {
        ...
        $("body").on("click","#step01",function(){
            ...
            $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=3",'_self');
        });
        ...
        $("body").on("click","#step02",function(){
            ...
            window.open('../zouban/interestChooselesson.do?version=58&term='+ encodeURI(encodeURI($('#termShow').val()))+'&gid='+
            $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=3",'_self');
        });
        $("body").on("click","#step03",function(){
            ...
            window.open('../paike/zhuzhouTeacher.do?version=58&term='+ encodeURI(encodeURI($('#termShow').val()))+'&gid='+
            $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=3",'_self');
        });
        ...
        $("body").on("click","#viewTable0",function(){
            ...
            +'&gid='+ $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&pub="+published+"&mode=3","_self");
        });
        $("body").on("click","#viewTable1",function(){
            ...
            +'&gid='+ $('#gradeShow').val()+'&gnm='+ encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=3","_self");
        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.ste<getNowFormatDate())
                        {
                            ...
                            window.open('../paike/adjustPage.do?index=7&version=1&gid='+ $('#gradeShow').val()+'&gnm='+
                            encodeURI(encodeURI($('#gradeShow').find('option:selected').text()))+"&mode=3",'_self');
                        }
                    }
                });
            }
        ...
        $(".gotoJinyuan").click(function(){
            window.open('../paike/changZhengIndex.do?version=58&year=&gradeId=','_self');
        })
    });
