...
<head>
    ...
    <script type="text/javascript" src="/static/js/groupchat/bootstrap.js?v=1"></script>
    ...
    <div id="content_main_container">
        <div id="content_main">
            ...
            <div id="right-container" <%--style="float: none"--%>>
                ...
                <div class="main-container" style="width: 830px;position: relative;top: 30px;margin-left: 20px;">
                    ...
                    <div class='headmaster-class-container'>
                        ...
                        <div class="class-titlebar">
                            ...
                            <ul class="info-select-bar">
                                ...
                                <li>
                                    <div class="select-detail" data-target="class-exampaper-container">本班考试</div>
                                    <div class="select-img"></div>
                                </li>
                                <%--<li>--%>
                        ...
                        <div class="everything-container">
                            ...
                            <div class='viewexampaper-container' style="background-color: white;">
                                <div class="viewexampaper-top">
                                    <span>试卷名称</span>|
                                    <span>日期</span>|
                                    <span>人数</span>|
                                    <span>状态</span>
                    ...
                    <!-- 通知结束 -->
                    <div style="margin-top: 30px; margin-bottom: 30px; text-align:center;overflow:visible;" id="allPages">
                        <div id="example" style="display:none;" class="22"></div>
                    </div>
