...
<div class="datail-main">
  ...
  <div class="detail-right">
    <div class="detail-right-top">
      ...
      <dl>
        ...
        <div class="detail-banner-bu">
          ...
          <button id="doexercise" style="display:none">去做进阶练习</button>
          <button id="getAnswer" style="display:none">查看进阶练习结果</button>
        </div>
        </dt>
        <dd>
          <p id="con"></p>
    ...
    <div class="course-view-container">
      ...
      <div  style=";height:400px;border:1px solid #ddd;background: #ffffff;margin-top: 10px;overflow-y: auto;word-break: break-all;display: block">
        ${text_content}
      </div>
      <div style="height: 38px;border: 1px solid #d4d4d4;background: url(/images/all_bg.png) repeat-x;background-color: #ebebeb;cursor: pointer;position: relative;">
                <span style="width: 21px;height: 22px;position: absolute;top: 10px;right: 20px;cursor: pointer;background: url(/images/V_all.png) no-repeat;">
