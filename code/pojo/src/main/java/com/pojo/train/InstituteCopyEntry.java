 ...
 * }
 */
public class InstituteCopyEntry extends BaseDBObject {
    ...
    public InstituteCopyEntry(){
        super();
    }

    public InstituteCopyEntry(BasicDBObject baseEntry) {
        super(baseEntry);
    }

    public InstituteCopyEntry(String name, String mainPic, String address, String telephone, String chuangLiShiJian,
