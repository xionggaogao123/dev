package com.fulaan.groupcollectmoney.util;
...
public class RSATool {
    ...
    public static void main(String[] args) {
        try {
            ...
            byte[] privateByte= (byte[]) v[0];
            byte[] publicByte= (byte[]) v[1];

            System.out.println("私钥"+Base64.encodeBase64String(privateByte));
            System.out.println("公钥"+Base64.encodeBase64String(publicByte));
//            //获得摘要
