package com.fulaan.personalcenter.controller;
...
public class PersonalCenterController extends BaseController {
    ...
    public String avatarEdit(String a,
                                String input,
                                String avatar1) throws Exception{
    ...
    public @ResponseBody Map<String,Object> updateAvatar(String imgpath1) throws Exception{
    ...
    public @ResponseBody Map<String,Object> modifyPassword(String password,String verycode, HttpServletResponse response,HttpServletRequest request) throws Exception{
        //todo : getmd5
        Map<String,Object> result = new HashMap<String, Object>();
