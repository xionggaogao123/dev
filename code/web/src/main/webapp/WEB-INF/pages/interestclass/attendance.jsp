...
<body classid="${classId}" type="1">
<%@ include file="../common_new/head.jsp" %>
<div id="content_main_container">
    <div class="c-manage-main" style="width: 900px">
        <%--<%@ include file="../common_new/col-left.jsp" %>
        <%@ include file="../common/right.jsp" %>--%>
        <div class="right-border">
            <div class="c-manage-right">
                <ul>
                    <li><a href="/myclass/interstat/${classId}">班级人员</a></li>
                    ...
                    <div class="hou">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="remark" placeholder="备注" style="width:200px;">
                                </td>
