...
window.webcam = {
	...
	swf_url: '/static/plugins/cameraform/htdocs/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '/static/plugins/cameraform/htdocs/shutter.mp3', // URI to shutter.mp3 sound
