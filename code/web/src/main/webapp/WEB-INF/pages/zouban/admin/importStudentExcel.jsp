        ...
        $(document).ready(function () {
            ...
            $(".buu").on("click", function () {
                if ($("#file").val() == "") {
                    ...
                    $("#myform").ajaxSubmit({
                        type: "post",
                        url: "/xuanke/importClassStudentData.do",
            ...
            $(".download").on("click", function () {
                window.location = '/xuanke/exportStudentExcel.do?gradeId=' + $("#gradeId").val();
            });
                ...
                <dl class="c-right-info">
                    ...
                    <div>
                        ...
                        <div class="notice-detail">
                            1.导入数据请严格按照模板，请勿改变用户名和班级名。
                        </div>
                        <div class="notice-detail">
                            2.此接口仅用于已有学生数据的情况，其他情况请通过平台生成数据。
                        </div>
                    </div>
                </dl>
