...
var CreateGroup = React.createClass({
    ...
    onSubmit: function () {
        ...
        // alert(JSON.stringify(friendsValues));

        var userIds = '';

        for(var i=0;i<friendsValues.length;i++){
          userIds += friendsValues[i].id + ',';
        }
        ...
        return (
            <div className='webim-friend-options'>
                ...
                <div className='webim-dialog webim-dialog-2'>
                    ...
                    <div ref='content'>
                        <Input defaultFocus='true' ref='input' placeholder={groupSubject}/>
                        {/**
                          <br/>
