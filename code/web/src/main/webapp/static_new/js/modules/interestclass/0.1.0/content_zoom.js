jQuery.fn.fancyZoom = function (options) {
    ...
    if ($('#zoom').length == 0) {
        var html = '<div class="round_shade_box" id="zoom" style="overflow: visible"> \
					<div class="round_shade_top" style="overflow: visible"> \
						<span class="round_shade_topleft"> \</span> \
						<span class="round_shade_topright"> \</span> \
					</div> \
					<div class="round_shade_centerleft" style="overflow: visible"> \
						<div class="round_shade_centerright"> \
							<div class="round_shade_center" id="zoom_content"> \</div> \
						</div> \
					</div> \
					<div class="round_shade_bottom" style="overflow: visible"> \
