...
<head>
    ...
    <script type="text/javascript" src="/static/js/manage/manage-school.js"></script>
        ...
        <div id="right-container">
            <div class="main-container">
                ...
                <div class="manage-right-container">
                    ...
                    <!-- 年级列表 -->
                    <div class="list-container grade-list" belong="grade" style="overflow: hidden;">
                        ...
                        <div class="batch-export"><i class="fa"></i> 批量导入人员</div>
                        <ul class="list-ul">
                            <li>
