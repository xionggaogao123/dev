                ...
                <div class="newPage-right">
                    <dl>
                        <dd>
                            ...
                            <a href="/zouban/baseConfig.do?index=7&version=1" class="newPage-right-pageview">
                                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-16.png">
                            </a>
                            <!--=====================微课超市=========================-->
                            <a href="/emarket?index=8&version=1" class="pageview-IV newPage-right-pagevieww newPageHover">
                            ...
                            <a href="/schoolSecurity/schoolSecurityPage.do?index=14" class="newPage-right-pagevieww">
