 ...
 */
@Api(value="管理员")
@RequestMapping("/jxmapi/admin")
@Controller
public class DefaultAdminController extends BaseController {

    private static final Logger EBusinessLog = Logger.getLogger(DefaultAdminController.class);
    @Autowired
    ...
    private static final Logger logger = Logger.getLogger(DefaultAdminController.class);
