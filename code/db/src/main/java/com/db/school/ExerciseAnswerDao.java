...
public class ExerciseAnswerDao extends BaseDao {
     ...
     * @param list
     */
    public void addSExerciseAnswerEntrys(List<ExerciseAnswerEntry> list) {
        save(MongoFacroty.getAppDB(), Constant.COLLECTION_EXERCISE_ANSWER_NAME, MongoUtils.fetchDBObjectList(list));
    }
     ...
     * @return
     */
    public List<ExerciseAnswerEntry> getList(ObjectId userId, List<ObjectId> documentIds, DBObject fields) {
        List<ExerciseAnswerEntry> retList = new ArrayList<ExerciseAnswerEntry>();
     ...
     * @param userScore
     */
    public void updateAnswer(ObjectId docId, ObjectId titleId, ObjectId userId, String answer, double userScore) {
