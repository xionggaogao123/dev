...
<head>
    ...
    <link href="/static_new/css/expressTemplate.css" rel="stylesheet">
            ...
            <table class="table table-bordered" style="TABLE-LAYOUT:fixed;WORD-BREAK:break-all">
                ...
                <script id="tbodyTmpl" type="application/template">
                    ...
                    <tr>
                        ...
                        <td><input name="firstPrice" type="text" value="{{=value.firstPrice}}" maxlength="5" required
                                   onkeyup="if(isNaN(value))execCommand('undo')"
                                   onafterpaste="if(isNaN(value))execCommand('undo')"></td>
                        <td><input name="addOnePrice" type="text" value="{{=value.addOnePrice}}" maxlength="5" required
                                   onkeyup="if(isNaN(value))execCommand('undo')"
                                   onafterpaste="if(isNaN(value))execCommand('undo')"></td>
...
<div id="addWin">
    ...
    <script type="application/template" id="provinceTempJs">
        ...
        <label style="width: 90px">
            {{?value.choose==1}}
            <input class="states" type="checkbox" name="check_name" value="{{=value.zn}}" disabled/><span
