package com.fulaan.file.service;
...
public class FileService {
    ...
    public List<String> uploadFile(ObjectId eduId, HttpServletRequest request, ObjectId userId, String fileField) throws IOException, IllegalParamException {
