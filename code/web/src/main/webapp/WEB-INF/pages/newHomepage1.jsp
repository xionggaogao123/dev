                    ...
                    <dl>
                        <dd>
                            ...
                            <a href="/user?version=1&index=2" class="pageview-IV newPage-right-pageview">
                                <img src="../../customizedpage/newspage/img/newLogoo-4.png">
                                <!--================微校园数量====================-->
                           ...
                           <%-- <a href="/schoolSecurity/schoolSecurityPage.do?version=30" class="pageview-I newPage-right-pageview">
                            ...
                            <!--===================微课@翻转课堂==========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover">
                                <img class="" src="../../customizedpage/newspage/img/newLogoo-5-H.png">
                                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
                            </a>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${(roles:isTeacher(sessionValue.userRole))}">
                                    <a href="/score/teacher.do?version=10&index=3" class="pageview-II newPage-right-pageview">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-5.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                    <a href="/score/student.do?version=10&index=3" class="pageview-II newPage-right-pageview">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-5.png">
                                    </a>
                                </c:when>
                                ...
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-II newPage-right-pageview">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-5-H.png">
                                    </a>
                         ...
                         <%--   <!--===================资源中心==========================-->
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-13-H.png">
                            </a>
                            <!--=====================办公OA=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover"  style="display: block">
                            ...
                            <%--<c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/docflow/documentList.do?type=0&index=5&version=1"  class="newPage-right-pagevieww">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogo-14.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/docflow/documentList.do?type=0&index=5&version=1"  class="newPage-right-pagevieww">
                                ...
                                <c:otherwise>
                                    <a href="javascript:;"  class="newPage-right-pagevieww">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogo-14-H.png">
                                    </a>
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-17-H.png">
                            </a>
                            <!--=====================云资源=========================-->
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="javascript:;" class="newPage-right-pageview">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogo-18-H.png">
                                    </a>
                                </c:otherwise>
                            ...
                            <a href="/elect/votePage.do?index=11&version=2" class="newPage-right-pageview">
                            ...
                            <a href="/chat?index=12" class="newPage-right-pagevieww">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-21.png">
                            </a>
                            <!--=====================阅卷系统=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover"  style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww"  style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-22-H.png">
                            </a>
                            <!--=====================校园安全监控=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-23-H.png">
                            </a>
                            <!--=====================直播点播=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-24-H.png">
                            </a>
                            <!--=====================一卡通=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-25-H.png">
                            </a>
                            <!--=====================教师评价系统=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-26-H.png">
                            </a>
                            <!--=====================平台管理=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover">
                            ...
                            <a href="/mobile" class="newPage-right-pagevieww">
                                <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-28.png">
                            </a>
                            <%--<!--===================学校管理==========================-->
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) ||
...
<script type="text/javascript">
    ...
    getMicroblogcount();
    //getNoticecount();
    //getLettercount();'${sessionValue.schoolId}'
</script>
</html>
