...
<head>
    ...
    <script type="text/javascript" src='/static/js/headmaster.js'></script>
...
//         	});
        ...
        $(function () {
            init();
            $('#username').val('${sessionValue.userName}');
            ...
            $('#file_attachblog').fileupload({
                ...
                start: function (e) {
                    ...
                    try {
                        ...
                        if (data.result) {
                            $('#img-container ul').append('<li><img class="blog-img" src="' + data.path[0] + '"><i class="fa fa-times blog-img-delete"></i></li>');
        ...
        $(function () {
            ...
            if (typeof showType != 'undefined' && showType.indexOf("index=9") > 0) {
                jQuery("#vote").addClass("active");
                jQuery("#vote").show();
                jQuery("#vote").trigger('click');
            }
...
<input type="hidden" id="hiddenValue" name="hiddenValue" value="<%=request.getParameter("tag")%>"/>
                ...
                <div id="info-banner-container"
                    ...
                    <div class="info-banner">
                        <div class="control-bar">
                            ...
                            <span id="vote" class="item" style="display:none;">投票选举</span>
                        </div>

                    </div>
                </div>

                <div class="main-container" style="width: 770px;position: relative;top: 30px;margin-left: 10px;">
                    ...
                    <!-- 微校园结束 -->
                    <!-- 我的投票开始 -->
                    <div class='vote-container'style="overflow: visible;display: none">
                        ...
                        <div class="tp-con tp-publish" style="width: 770px;">
                            <form action="">
                                <div class="clearfix tp-from-group">
                                    ...
                                    <div class="tp-col tpz"><input id="inputEmail3" class="tp-form-control" type="text" placeholder="请输入投票标题，不得超过20个字" style="height: 32px;"></div>
                                </div>
                                <div class="clearfix tp-from-group">
					        ...
					        <span style="margin-right:20px;margin-top:10px;font-weight:bold;font-size:16px;color:#fff;float:right;">
					            ...
					            <span onclick="confirmCandidate()" style="cursor:pointer;float:right;width:75px;height:25px;background:#ff7625;color:#fff;margin-top:14px;font-size:14px;font-weight:bold;line-height:25px;">确定
                                    ...
                                    <div class="contact-div" style="overflow: auto!important;">
                                ...
                                <div class="clearfix tp-from-group">
                                    ...
                                    <div class="tp-col clearfix ">
                                        <input class=" tp-form-control tpz inputtime" type="number" style="width:185px;height: 32px;" id="ballotCount"  min="1" value="3"/>
                                    </div>
                                </div>
                                <div class="clearfix tp-from-group">
                                    <label class="tp-control-label tpz tp-h-center">开始日期</label>
                                    <div class="tp-col clearfix ">
                                        <input style="height: 32px" class="Wdate tp-form-control tpz inputtime" type="text" style="width:185px;" id="starttimeforvote"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d',maxDate:'#F{$dp.$D(\'closetimeforvote\')}'})" value=""/>
                                    </div>
                                </div>
                                <div class="clearfix tp-from-group">
                                    <label class="tp-control-label tpz tp-h-center">结束日期</label>
                                    <div class="tp-col clearfix ">
                                        <input style="height: 32px;" class="Wdate tp-form-control tpz inputtime" type="text" style="width:185px;" id="closetimeforvote"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'starttimeforvote\')}'})" value=""/>
                    ...
                    <div class='headmaster-class-container'>
                        ...
                        <div class="class-list">
                            <ul class='headmaster-select-class' style="width: 790px">
                                ...
                                <%--<s:iterator value="GradeIdList" id = "gl">--%>
                                <%--<li  gid="${gl.status}">${gl.description}</li>--%>
                                <%--</s:iterator>--%>
                            </ul>
                    ...
                    <%--<s:iterator value="subjectList" id = "sl">--%>
                    <%--<li sid="${sl.gradeId}">${sl.subjectName}</li>--%>
                    <%--</s:iterator>--%>
                    <%--</ul>--%>
                    <%--</div>--%>
                    ...
                    <%--<li class="active">全部年级</li>--%>
                    <%--<s:iterator value="GradeIdList" id = "gl">--%>
                    <%--<li  cid="${gl.status}">${gl.description}</li>--%>
                    <%--</s:iterator>--%>
                    <%--</ul>--%>
                    <%--</div>--%>
