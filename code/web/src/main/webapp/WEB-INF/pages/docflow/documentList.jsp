        ...
        <div class="tab-col">
            ...
            <div class="tab_main">
                ...
                <script type="application/template" id="myDocJs">
                    <a href="/docflow/documentCreate.do?version=51" class="Zx">撰写</a>
                    <table width="100%">
                        <thead>
                        <tr>
                            <th>公文标题</th>
                        ...
                        <tr>
                            ...
                            <td onclick="location.href='/docflow/myDocumentModify.do?docId={{=value.id}}&version=51'"
                                class="CK">编辑
                            </td>
                            {{??}}
                            <td onclick="location.href='/docflow/documentDetail.do?docId={{=value.id}}&p='+
                            encodeURI(encodeURI('{{=value.checkPerson}}'))+'&d='+encodeURI(encodeURI('{{=value.checkDepartment}}'))+'&type=2&version=51'"
                                class="CK">查看
                            </td>
                            {{?}}
                        </tr>
                        ...
                        <tr>
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole)||roles:isManager(sessionValue.userRole)}">
                                    <td class="CK"><em
                                            onclick="location.href='/docflow/documentDetail.do?docId={{=value.id}}&p=&d=&type=0&version=51'">查看</em>|
                                        <em onclick="location.href='/docflow/documentModify.do?docId={{=value.id}}&type=0&version=51'">编辑</em>|
                ...
                <script type="application/template" id="uncheckJs">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>{{=value.checkTime}}</td>
                            <td class="CK"
                                onclick="location.href='/docflow/documentCheck.do?docId={{=value.id}}&version=51'">审阅
                            </td>
                        </tr>
                        {{~}}
                        </tbody>
                ...
                <script type="application/template" id="checkedDocJs">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>{{=value.stateDesc}}</td>
                            <td>{{=value.checkTime}}</td>
                            <td onclick="location.href='/docflow/documentDetail.do?docId={{=value.id}}&p=&d=&type=1&version=51'"
                                class="CK">查看
                            </td>
                        </tr>
                        {{~}}
