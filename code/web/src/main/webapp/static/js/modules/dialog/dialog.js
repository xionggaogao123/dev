var Showbo = {author: 'showbo', homepage: 'http://www.ycode.cn'};
//是否为ie浏览器
...
Showbo.Msg = {
    ...
    alert: function (msg, tit) {
        this.show({buttons: {yes: '确认'}, msg: msg, title: tit || '消息'});
    },
    confirm: function (msg, tit, fn) {
        //fn为回调函数，参数和show方法的一致
        this.show({buttons: {yes: '确认', no: '取消'}, msg: msg, title: tit || '提示', fn: fn});
    },
    ...
    onResize: function (isResize) {
        ...
        Showbo.Msg.dvMsgBox.style.marginTop = -Math.floor($(Showbo.Msg.dvMsgBox).outerHeight() / 2) + 'px'
