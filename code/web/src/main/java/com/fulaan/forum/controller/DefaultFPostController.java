...
@Api(value="帖子、板块处理中心")
@Controller
@RequestMapping("/jxmapi/forum")
public class DefaultFPostController extends BaseController {

    private static final Logger logger = Logger.getLogger(DefaultFPostController.class);
