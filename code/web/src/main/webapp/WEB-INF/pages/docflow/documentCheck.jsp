...
<div id="content" class="clearfix">
    ...
    <div class="col-right">
        ...
        <div class="tab-col">
            ...
            <div class="tab_main">
                <a href="/docflow/documentList.do?type=1&version=51" class="Bk"> < 返回</a>
                <a href="/docflow/documentModify.do?docId={{=it.id}}&type=1&version=51" id="goToHref" class="tab-XG">修改原文</a>
