...
<div class="pet-tab">
  <a href="#" class="title_a"><span class="pet-tab-common active">余额历史</span></a>
</div>
...
<div id="fc_student_score_history" class="fc_statistics_list ypheader center">
  ...
  <div class="header">
    <span class="I">余额基数</span>|
    <span class="II">余额状况</span>|
    <span class="III">操作时间</span>
  </div>
