...
<title>平台运营活动</title>
    ...
    <script type="text/javascript" src="/static/js/businessactivity/create.js"></script>
	...
	<div class="inform-all">
		...
		<div class="informm-main">
			...
			<div class="inform-main">
				...
				<form id="form" action="/business/add.do" method="POST">
                    ...
                    <input type="hidden" id="eduIdsStr" name="eduIdsStr" value="">

                </form>
				<!--===========================编辑火热活动===============================-->
				<div class="compile-main" id="compile_in">
					<div class="compile-top">
						<span>标题</span> <input id="title_input" class="compile-top-input"type="" name="" value="">
					</div>
                    ...
                    <div style="margin-left: 55px;margin-top: 8px;">
                        即时生效: <input type="checkbox" name="effect" value="0">
                    </div>
