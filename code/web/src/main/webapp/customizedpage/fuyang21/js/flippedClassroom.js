            ...
            success: function (data) {
                ...
                for(var i=0;i<data.length;i++)
                {
                    ...
                    infocontent+='<dl >'+
                        ...
                        '<dd>'+
                        '<h5><a href="/customizedpage/fuyang21/news_fuyang21.jsp?newsId='+data[i].id+'">'+data[i].title.substring(0,60)+'</a></h5>'+
                        '<p>'+digest+'</p>'+
                        '<a class="btn-more" href="/customizedpage/fuyang21/fuyang21.jsp?type=news"></a>'+
                        '</dd>'+
                        '</dl>';
    ...
    $.ajax(
        {
            ...
            success: function (data) {
                ...
                target.empty();
                var contenthead='<dt><span>【公告】</span><a class="bg-more" href="/customizedpage/fuyang21/fuyang21.jsp?type=notice"></a></dt>';
                ...
                for(var i=0;i<data.length;i++)
                {
                    ...
                    var infocontent="";
                    infocontent+='<dd>'+
                        '<a href="/customizedpage/fuyang21/notice_fuyang21.jsp?newsId='+data[i].id+'"><span>'+data[i].title+'</span><em>'+date+'</em></a>'+
                        '</dd>';
