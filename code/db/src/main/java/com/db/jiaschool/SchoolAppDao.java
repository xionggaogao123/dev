...
public class SchoolAppDao extends BaseDao {
    ...
    public ObjectId addEntry(SchoolAppEntry entry){
        save(MongoFacroty.getAppDB(), Constant.COLLECTION_SCHOOL_APP, entry.getBaseEntry());
        return entry.getID();
    }
    ...
    public void updEntry(SchoolAppEntry e) {
        ...
        update(MongoFacroty.getAppDB(), Constant.COLLECTION_SCHOOL_APP, query,updateValue);
    }
    ...
    public SchoolAppEntry getEntryById(ObjectId schoolId) {
        ...
        DBObject obj =
                findOne(MongoFacroty.getAppDB(), Constant.COLLECTION_SCHOOL_APP, query, Constant.FIELDS);
        if (obj != null) {
