...
// }
    ...
    public static Map<String, String> sendTextMessage(String appKey, String token,
                                                      String textContent, String fromUser, List<String> toUsernames,String nickname,String imageUrl) throws IOException,
        ...
        if (StringUtils.isNotEmpty(nickname)) {
        	extBody.put("attr1", nickname);
        } else {
        	extBody.put("attr1", "v1");
        }
        if (StringUtils.isNotEmpty(imageUrl)) {
        	extBody.put("attr2", imageUrl);
        } else {
    ...
    public static HashMap Login(String hostDomain, String appKey, String username, String password)
            throws IOException, KeyManagementException, NoSuchAlgorithmException {
        String host = "https://" + hostDomain;
        String orgName = appKey.substring(0, appKey.lastIndexOf("#"));
        String appName = appKey.substring(appKey.lastIndexOf("#") + 1);
        Client client = getClient(true);
        ...
        payload.put("client_id", "YXA6Bm3RIB0QEeSvNln_JrRkqw");
        payload.put("client_secret", "YXA65OLZwlUEyqUPqYVyntXEN0rpfUE");
        Response response = target.request(MediaType.APPLICATION_JSON_TYPE)
                .buildPost(Entity.json(payload)).invoke();
