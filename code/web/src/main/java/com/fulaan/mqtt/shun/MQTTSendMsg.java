...
public class MQTTSendMsg {
    public static void sendMessage(final String code) throws IOException{
        /**
         ...
         */
        final String clientId ="GID_jxm@@@ClientID_0000";
        String sign;
