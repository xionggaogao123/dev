...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/customizedpage/changzheng/css/style.css"/>
    <link rel="stylesheet" type="text/css" href="/customizedpage/tangzhen/css/main.css"/>
...
<div class="main-container">
    <div class="login-bar" style="margin: 0 auto;">
        <div class='title-bar-container' style="height:105px;overflow: hidden;z-index: 1">
            <img class="title-logo" src="/customizedpage/tangzhen/img/tangzhen-logo.jpg">
    ...
    <div class="main-content-container">
        ...
        <div class='content-container' style="z-index: 1">
            ...
            <img class="text-1" src="/img/K6KT/main-page/tangzhen-ziti.png"/>
           ...
           <%-- <div class="teacher-apply" onclick="go2appuse()">
            ...
            <div class="monitor-div">
                <div class="carousel nivoSlider" id='slider'>
                    <img src="/img/K6KT/main-page/tangzhen-xiaoxun.png"/>
