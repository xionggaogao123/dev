...
<div id="content" class="clearfix">
    ...
    <div class="col-right">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <div class="dd-div voteCatogery" id="classListShow">
                                    <label>
                                        <input type="checkbox" value="" title="全部学校"
                                               class="view-catogery">全部学校
                                    </label>
                                </div>
        ...
        <!--=============学校用户名start============================-->
        <div class="sch-na">
            <div class="sch-na-top">
                <em></em><i class="chanle-user">X</i>
            </div>
            <dl class="sch-na-main">
                <dd class="sch-na-dd">
                    <em>学校：</em>
                    <select id="schoolId">
                ...
                <dd>
                    <div class="sch-na-bottom">
                        <span class="sure-user">确定</span>
                        <span class="chanle-user">取消</span>
                    </div>
                </dd>
            </dl>
        </div>
...
<script>
    seajs.use('/static_new/js/modules/yunying/0.1.0/vote');
</script>
</body>
</html>
