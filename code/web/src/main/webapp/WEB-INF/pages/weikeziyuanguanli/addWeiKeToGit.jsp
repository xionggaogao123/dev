            ...
            <div class="add-ziyuan-col">
                ...
                <div class="form-col">
                    ...
                    <div class="form-main clearfix complex-value-class">
                        ...
                        <input id="subjectType" type="hidden" value="${dto.subjectType}"/>
                        <input id="gradeType" type="hidden" value="${dto.gradeType}"/>
                        <input id="type" type="hidden" value="${dto.type}"/>
                            ...
                            <dd>
                                ...
                                <select id="termTypeSel" name="termTypeSel" typeInt="1">
                                    ...
                                    <c:forEach items="${styStionList}" var="sty">
                                        <option value="${sty.type}" <c:if test="${sty.type==dto.schoolType}">selected</c:if>>${sty.value}</option>
                                    </c:forEach>
                                </select>
                            </dd>
                            <dd>
            ...
            <div class="form-col">
                ...
                <div class="form-main uploader-info">
                    ...
                    <div class="clearfix">
                        ...
                        <input id="oldVideoId" type="hidden" value="${dto.videoId}"/>
                    ...
                    <div class="clearfix">
                        ...
                        <input id="imageUrl" type="hidden" value="${dto.imageUrl}"/>
...
<script>
    seajs.use('addWeiKeToGit',function(addWeiKeToGit){
        addWeiKeToGit.init();
    });
</script>
</body>
