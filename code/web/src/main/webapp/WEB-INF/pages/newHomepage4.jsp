        ...
        <dl>
            ...
            <dd>
                ...
                <div class="newPage-right">
                        ...
                        <dd>
                           ...
                           <%-- <a href="/schoolSecurity/schoolSecurityPage.do?version=30" class="pageview-I newPage-right-pageview">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${(roles:isTeacher(sessionValue.userRole))}">
                                    <a href="/lesson/teacher.do?version=1&index=3" class="pageview-II newPage-right-pageview">
                         ...
                         <%--   <!--===================资源中心==========================-->
                            ...
                            <a href="javascript:;" class="newPage-right-pageview" style="display: none">
                                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-16-H.png">
                            </a>
                            <!--=====================微课超市=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover">
                            ...
                            <a href="/cloud/cloudLesson.do?version=61&type=1" class="newPage-right-pagevieww" style="display: none">
                            ...
                            <a href="javascript:;" class="newPage-right-pageview" style="display: none">
                                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-20-H.png">
                            </a>
                            <!--=====================群组交流=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-21-H.png">
                            </a>
                            <!--=====================阅卷系统=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <a href="javascript:;" class="newPage-right-pagevieww" style="display: none">
                                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-23-H.png">
                            </a>
                            <!--=====================直播点播=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block">
                            ...
                            <c:choose>
                                ...
                                (roles:isTeacher(sessionValue.userRole) && roles:isManager(sessionValue.userRole))}">
                                    <a href="/myschool/managesubject?index=18&version=1&tag=1" class="pageview-VIIII newPage-right-pagevieww"  style="display: none">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/manageCount/schooltotal.do?index=18&version=1&schoolid=${sessionValue.schoolId}" class="pageview-VIIII newPage-right-pagevieww"  style="display: none">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-VIIII newPage-right-pagevieww"  style="display: none">
                    ...
                    <div class="newPage-FL" style="display: none">
                        <!--微校园-->
