...
//            throw new IllegalParamException();
        ...
        Runnable handler=new Runnable() {
            ...
            public void run() {
                ...
                CloudResourceService cloudResourceService =new CloudResourceService();
                try {
                    ...
                    if (persistentId != null) {
                        ...
                        cloudResourceService.update(videoId, "pid", persistentId);
                    }
                    //
                }
                catch (Exception e){
                    ...
                    cloudResourceService.updateVideoUpdateStatus(videoId,2);
