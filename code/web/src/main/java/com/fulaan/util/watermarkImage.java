...
public class watermarkImage {
    ...
    public watermarkImage(BufferedImage image) {
        this.image = image;
        iw = image.getWidth();
        ih = image.getHeight();
...
//        String filePath="F:/k7qp5.png";
        String url="http://qcloud.dpfile.com/pc/d2Qj9-6s60A_oKGJ-qV_oNM4aRE7OIEXCUIXmZ-R9_q7i7vV9ObJPOsO43b14yI-TYGVDmosZWTLal1WbWRW3A.jpg";
        String fileName="test4.jpg";
        String path="D:\\water";
        DownloadUtil.downLoadFromUrl(url,fileName,path);
//        String filePath=path+"\\"+fileName;
//        clearWaterMark(filePath);
//        FileInputStream fin = new FileInputStream(filePath);
//        BufferedImage bi = ImageIO.read(fin);
//        watermarkImage flt = new watermarkImage(bi);
//        flt.changeGrey();
//        flt.getGrey();
//        flt.getBrighten();
