...
<div id="content_main_container">
    <div id="content_main">
        ...
        <div class="course-view-container">
            ...
            <div <%--id="videoplayer-div"--%>style=";height:400px;border:1px solid #ddd;background: #ffffff;margin-top: 10px;overflow-y: auto;word-break: break-all;display: block;overflow-x:hidden;">
                    <embed src="${swf_path}" quality="high" wmode="transparent" bgcolor="#ffffff" width="865" height="1000" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
