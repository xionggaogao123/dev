                ...
                <div class="newPage-right">
                    <dl>
                        <dd>
                            ...
                            <a href="/user?version=1&index=2" class="pageview-IV newPage-right-pageview" style="display: none;">
                            ...
                            <!--===================微课@翻转课堂==========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover" style="display: inline-block">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${(roles:isTeacher(sessionValue.userRole))}">
                                    <a href="/homework/teacher.do?version=5&index=3&type=keqian" class="pageview-II newPage-right-pageview"  style="display: none;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-5.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                    <a href="/homework/student.do?version=5&index=3&type=keqian" class="pageview-II newPage-right-pageview"  style="display: none;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-5.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) && roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/testpaper/list.do?version=5&index=3" class="pageview-II newPage-right-pageview"  style="display: none;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-5.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-II newPage-right-pageview"  style="display: none;">
                            ...
                            <!--=====================互动课堂=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: inline-block">
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/docflow/documentList.do?type=0&index=5&version=1"  class="newPage-right-pagevieww" style="display:none;">
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/zouban/baseConfig.do?index=7&version=1" class="newPage-right-pageview manageZbHref" style="display: inline-block">
                                ...
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/zouban/teacher.do?index=7&version=4" class="newPage-right-pageview" >
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-16.png" style="display: inline-block">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isStudent(sessionValue.userRole)}">
                                    <a href="/zouban/student.do?index=7&version=4&tag=2" class="newPage-right-pageview" style="display: inline-block">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-16.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="javascript:;" class="newPage-right-pageview" style="display: inline-block">
                                        <img class="newpage-WK" src="../../customizedpage/newspage/img/newLogoo-16.png">
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <a href="/emarket?index=8&amp;version=1" class="newPage-right-pagevieww"  style="display: none;">
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/cloud/cloudLesson.do?index=9&version=1&type=1" class="newPage-right-pagevieww"  style="display: none;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/cloudres/load.do?index=9&version=3" class="newPage-right-pagevieww" style="display: none;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}" >
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/myclass/tointerestclass?index=10" class="newPage-right-pageview" style="display:none;"> 
                                ...
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                    <a href="/myclass/toselinclass?index=10" class="newPage-right-pageview" style="display:none;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-19.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <a href="/business/fieryactivitylist.do?index=11" class="newPage-right-pageview"  style="display: none;">
                            ...
                            <a href="/chat?index=12" class="newPage-right-pagevieww" style="display:none;">
                            ...
                            <c:choose>
                                ...
                                (roles:isTeacher(sessionValue.userRole) && roles:isManager(sessionValue.userRole))}">
                                    <a href="/myschool/managesubject?index=18&version=1&tag=1" class="pageview-VIIII newPage-right-pagevieww" style="display: inline-block">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/manageCount/schooltotal.do?index=18&version=1&schoolid=${sessionValue.schoolId}" class="pageview-VIIII newPage-right-pagevieww" style="display: inline-block">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-VIIII newPage-right-pagevieww" style="display: inline-block">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <a href="/mobile" class="newPage-right-pagevieww"  style="display: none;">
