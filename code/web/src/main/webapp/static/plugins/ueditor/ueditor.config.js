...
(function () {
    ...
    var imgUpload=window.UEDITOR_IMG_UPLOAD_URL||URL;
    var subUpload="";

    if(imgUpload=='/upload/'){
        subUpload="";
    }else{
        subUpload=imgUpload+"jsp/";
    }
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"jsp/imageUp.jsp?imgUpload="+imgUpload            //图片上传提交地址
        ,imagePath:subUpload                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
...
//        }
        ...
        ,zIndex : 990000000     //编辑器层级的基数,默认是900
