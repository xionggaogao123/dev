...
<head>
    ...
    <script type="text/javascript" src="/customizedpage/fuyang21/js/newsAndNotice.js"></script>
    <!--[if IE 6]>
...
<div class="middle_info">
    <dl>
        <dt><a href="/customizedpage/fuyang21/flippedClassroom.jsp">首页</a>&nbsp;>&nbsp;<a href="//customizedpage/fuyang21/fuyang21.jsp?type=notice">公告首页</a></dt>
        <dd>
            <table>
                <tr>
                    <!--==============================左边部分==============================-->
                    <td>
                        <div class="middle_left">
                            <ul>
                                <li><a href="/customizedpage/fuyang21/fuyang21.jsp?type=notice"class="cur">公告</a></li>
                                <li><a href="/customizedpage/fuyang21/fuyang21.jsp?type=news">新闻</a></li>
                            </ul>
                        </div>
                    </td>
                    <!--==============================公告部分==============================-->
...
<%--
                                    <p>爱了就点开放辣死快点减肥拉开手机对法拉克手机对法拉克司法局 拉会计法埃里克受打击阿里款到即发拉克丝鉴定费阿里快睡觉狄拉克四季度发生颗粒剂发卡量就离开爱家卡洛斯的减肥拉快睡觉阿卡加的拉科技案例</p>
--%>

                                </div>
                                <div class="news_main_f">
                                    <a href="/customizedpage/fuyang21/flippedClassroom.jsp">< 返回首页</a><i>下一条 ></i><i>< 上一条</i>
                                </div>
                            </dl>
                        </div>
                    </td>
