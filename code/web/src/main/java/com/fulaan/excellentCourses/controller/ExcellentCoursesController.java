...
public class ExcellentCoursesController extends BaseController {
    ...
    public String buyClassList(@ApiParam(name = "id", required = true, value = "id") @RequestParam("id") String id,
        ...
        try {
            ...
            String result = excellentCoursesService.buyClassList(new ObjectId(id),getUserId(),classIds,ipconfig);
    ...
    public String getAccount(){
        ...
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            double result = excellentCoursesService.getAccount(getUserId());
            respObj.setMessage(result);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
    ...
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/getNewSimpleCourses")
    @ResponseBody
    public String getNewSimpleCourses(){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            Map<String,Object>  dto = excellentCoursesService.getNewSimpleCourses(getUserId());
            respObj.setMessage(dto);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
    ...
    public String gotoClass(@ApiParam(name = "id", required = false, value = "id") @RequestParam(value="id",defaultValue = "") String id){
        ...
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            Map<String,Object>  dto = excellentCoursesService.gotoThreeClass(new ObjectId(id),getUserId());
            respObj.setMessage(dto);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
    ...
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/gotoThreeClass")
    @ResponseBody
    public String gotoThreeClass(@ApiParam(name = "id", required = false, value = "id") @RequestParam(value="id",defaultValue = "") String id){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
     ...
     * 家长孩子们的购买课程
     */
    @ApiOperation(value = "家长孩子们的购买课程", httpMethod = "GET", produces = "application/json")
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/getMyChildBuyCoursesList")
    @ResponseBody
    public String getMyChildBuyCoursesList(@ApiParam(name= "孩子id",required = true,value="")@RequestParam("sonId") String sonId){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            Map<String,Object> map = excellentCoursesService.getMyChildBuyCoursesList(new ObjectId(sonId));
            respObj.setMessage(map);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
            respObj.setErrorMessage("家长孩子们的购买课程失败!");
        }
        return JSON.toJSONString(respObj);
    }
     ...
     * 家长孩子们的推荐课程
     */
    @ApiOperation(value = "家长孩子们的推荐课程", httpMethod = "GET", produces = "application/json")
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/getMyChildCommunityCoursesList")
    @ResponseBody
    public String getMyChildCommunityCoursesList(@ApiParam(name= "孩子id",required = true,value="")@RequestParam("sonId") String sonId){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            Map<String,Object> map = excellentCoursesService.getMyChildCommunityCoursesList(new ObjectId(sonId),getUserId());
            respObj.setMessage(map);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
            respObj.setErrorMessage("家长孩子们的活跃课程失败!");
        }
        return JSON.toJSONString(respObj);
    }
    ...
    /**
     * 判断是否为特殊直播间（合并直播间、多直播间）
     */
    @ApiOperation(value = "判断是否为特殊直播间", httpMethod = "GET", produces = "application/json")
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/booleanBackList")
    @ResponseBody
    public RespObj booleanBackList(@ApiParam(name = "id", required = true, value = "课节id") @RequestParam("id") String id){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            Map<String,Object> map = excellentCoursesService.booleanBackList(new ObjectId(id), getUserId());
            respObj.setMessage(map);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
    ...
    public String buyChildClassList(@ApiParam(name = "id", required = true, value = "id") @RequestParam("id") String id,
        ...
        try {
            ...
            String result = excellentCoursesService.buyChildClassList(new ObjectId(id),getUserId(),classIds,new ObjectId(sonId),ipconfig);
            respObj.setMessage(result);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
     ...
     *  退课查询
     */
    @ApiOperation(value = "退课查询", httpMethod = "GET", produces = "application/json")
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    ...
    public String refund(@ApiParam(name = "id", required = true, value = "id") @RequestParam("id") String id,
        ...
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            excellentCoursesService.refund(new ObjectId(id), getUserId(), new ObjectId(sonId));
     ...
     *  查询支付宝账户
     */
    @ApiOperation(value = "查询支付宝账户", httpMethod = "GET", produces = "application/json")
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/getApppliAccount")
    @ResponseBody
    public String getApppliAccount(){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            String name = excellentCoursesService.getApppliAccount(getUserId());
            respObj.setMessage(name);
        } catch (Exception e) {
            e.printStackTrace();
            respObj.setCode(Constant.FAILD_CODE);
            respObj.setErrorMessage(e.getMessage());
     ...
     *  获取直播间状态
     */
    @ApiOperation(value = "获取直播间状态", httpMethod = "GET", produces = "application/json")
    @ApiResponses( value = {@ApiResponse(code = 200, message = "Successful — 请求已完成",response = String.class),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
            @ApiResponse(code = 500, message = "服务器不能完成请求")})
    @RequestMapping("/getRoomStatus")
    @ResponseBody
    public RespObj getRoomStatus(@ApiParam(value="roomId",required = true,name="roomId")@RequestParam(value="roomId",required = true)String roomId){
        RespObj respObj=new RespObj(Constant.FAILD_CODE);
        try {
            respObj.setCode(Constant.SUCCESS_CODE);
            int status = excellentCoursesService.getRoomStatus(roomId);
