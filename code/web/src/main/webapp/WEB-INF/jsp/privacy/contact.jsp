    ...
    <div class="company-info-container">
        <div class="info-left">
            ...
            <dl class="contact-us-dl">
                ...
                <dd class="showerror"><textarea maxlength="1000" id="message_text"
                                                style="width:530px;height:220px;padding:10px;background-color:#EFEFEF;font:13px Helvetica,Arial,sans-serif"></textarea><span
                        class="showerror"></span></dd>

                <dt><input id="submitBtn" type="button" value="提交" onclick="submitMessage();"
                           style="background: #00c2f3;color: white;cursor: pointer;height: 28px;width: 80px;"/></dt>
