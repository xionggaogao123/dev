  ...
  <div class="col-right" style="width: 1000px;">
    ...
    <div class="grow-col">
      ...
      <div class="grow-tab-head clearfix">
        <ul>
          <li class="cur"><a href="#cjdId">成绩单</a></li>
          <li ><a href="#szeduId">素质教育</a></li>
        </ul>

        <!-- <h4 class="click">成绩单</h4>
        <h4>素质教育</h4> -->
      </div>
      ...
      <div>
        ...
        <div class="hide szedu" id="szeduId">
          ...
          <table class="suzhiedu" width="100%">
            ...
            <tr>
              <td rowspan="6"class="rowspan">道德素质</td>
              <td>热爱祖国</td>
              <td class="flushLeft">尊敬国家标志，关心国内外大事和时事政治</td>
              <td>优</td>
              <td>优</td>
              <td rowspan="6" >优  </td>
            </tr>
