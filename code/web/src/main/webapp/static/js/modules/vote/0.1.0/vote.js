            ...
            success: function (response) {
                ...
                if ($('.vote-cont').is(':hidden')) {
                    ...
                    if (targetList.length > 1) {
                        ...
                        $(this).parent().prev().find(".hxr-hxr").eq(0).append('<span class="no-hxr">目前没有候选人哦~~快快报名吧!</span>');
                    }
                ...
                $('.videoforvote').fileupload({
                    ...
                    formData: {'type': 'elect'},
                        ...
                        $(this).closest('.tp-bm-box').find('.vote-vedio-container ul').html('<li data-id="' + response.result.videoInfo.id + '">' +
                            '<img class="candidate-vedio-cover" src="' + imgUrl + '"></img><img src="/static/images/play.png" class="video-play-icon"/><i class="fa fa-times blog-img-delete"></i></li>');
                    },
                    progressall: function (e, data) {
