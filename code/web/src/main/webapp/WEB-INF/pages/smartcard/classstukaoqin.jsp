            ...
            <div class="clearfix stukq-nav">
                <ul class="clearfix stukq-ul">
                    ...
                    <c:if test="${roles:isHeadmaster(sessionValue.userRole)}">
                        <li class="stukq-active"><a href="javascript:;">班级考勤统计详情</a><em></em></li>
                        <li><a href="/smartCard/teaKaoQin.do">老师考勤统计</a><em></em></li>
                    </c:if>
                </ul>
            </div>
            <div class="stukq-mian">
                <p class="headkq-back">&lt;返回班级学生考勤列表</p>
                ...
                <span class="mykq-grade">${gradeName}${className}</span>
                    <ul>
                ...
                <script type="text/template" id="j-tmpl">
                    ...
                    {{var obj=it.list[i];}}
                    <tr class="user-tr" style="cursor: pointer;" id="{{=obj.userId}}">
                        <td style="background:#ececec;color:#3999d4;">
                            {{=obj.userName}}
                        </td>
                        <td>
                            {{=obj.normalCount}}/{{=it.kaoQinTotal}}
                        </td>
                        <td>
                            {{=obj.lateCount}}
                        </td>
...
<script>
    seajs.use('classstukaoqin',function (classstukaoqin) {
        classstukaoqin.init();
    });
</script>
