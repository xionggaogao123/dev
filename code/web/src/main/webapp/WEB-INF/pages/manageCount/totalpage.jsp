...
<div class="student_infromation_main">
    ...
    <div class="right">
        <div class="right_top">
            <p>
                <a href="javascript:;" class="current">平台使用统计</a><a href="javascript:;" style="width:130px;" onclick="location.href='/manageCount/functionUse.do?schoolId=${schoolid}'">平台功能统计</a>
            </p>
            <div class="select">
