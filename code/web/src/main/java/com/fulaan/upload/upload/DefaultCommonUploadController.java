...
@Controller
@RequestMapping("/jxmapi/commonupload")
public class DefaultCommonUploadController extends BaseController {

    private static final Logger logger = Logger.getLogger(DefaultCommonUploadController.class);
