<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<div id="footer" style="font-size: 12px;  clear: both;  overflow: hidden">
    <div style="width: 1000px;margin: 0 auto">
        ...
        <span style="float: right"><a href="/aboutus/k6kt">关于我们</a>  |  <a href="/contactus/k6kt">联系我们</a>   |  <a
                href="/service/k6kt">文明守则 </a> |  <a href="/privacy/k6kt">隐私保护 </a> |  <a
                href='http://wpa.qq.com/msgrd?v=1&uin=2803728882&site=qq&menu=yes' target="_blank"><img
                style="width: 83px;height: 22px;" src="/static/images/QQService.png"></a></span>
    </div>
</div>