...
define(['doT', 'common', 'jquery', 'rome', 'initPaginator'], function (require, exports, module) {
    ...
    $(document).ready(function () {
        ...
        $("body").on("click", "#step01", function () {
            ...
            $('#gradeShow').val() + '&gnm=' + encodeURI(encodeURI($('#gradeShow').find('option:selected').text())) + "&mode=2", '_self');
        });
        ...
        $("body").on("click", "#viewTable0", function () {
            ...
            + '&gid=' + $('#gradeShow').val() + '&gnm=' + encodeURI(encodeURI($('#gradeShow').find('option:selected').text())) + "&pub=" + 1 + "&mode=2", "_self");
        });
        $("body").on("click", "#viewTable1", function () {
            ...
            + '&gid=' + $('#gradeShow').val() + '&gnm=' + encodeURI(encodeURI($('#gradeShow').find('option:selected').text())) + "&mode=2", "_self");
        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.ste < getNowFormatDate()) {
                            ...
                            encodeURI(encodeURI($('#gradeShow').find('option:selected').text())) + "&mode=2", '_self');
                        }
                    }
                });
            }
        ...
        $(".gotoJinyuan").click(function () {
            window.open('../paike/index.do?version=58&term=&gradeId=', '_self');
        })
    });
    //获取当前时间
    ...
    zoubanindex.showProgress = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".v4").find("div").attr("state", 0);
                $(".v5").find("div").attr("state", 0);
