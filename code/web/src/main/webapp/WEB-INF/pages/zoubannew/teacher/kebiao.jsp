    ...
    <div class="col-right">
        ...
        <div class="tab-col">
            ...
            <div class="tab-head clearfix">
                <ul>
                    <li id="MYTABLE" class="cur"><a href="javascript:;">我的课表</a><em></em></li>
                    <li id="XZB"><a href="javascript:;" >行政班课表</a><em></em></li>
            ...
            <div class="tab-main">
                <!--=========================================我的课表开始=================================================================-->
                <div class="lskb-con" id="tab-MYTABLE" style="display: block;">
                    <div class="fifthstep-title clearfix">
                        <a href="javascript:;" class="fstep-dc" id="exportMyself">导出</a>
                    </div>
                    <table class="newTable" id="myselfTable">
                        <thead>
                        <tr>
                            <th>上课时间</th>
                            <th>周一</th>
                    ...
                    <script type="application/template" id="myselfTableTmpl">
                        <thead>
                        <tr>
                            <th width="20%">上课时间</th>
                    ...
                    <div class="fifthstep-title clearfix">
                        <div class="fstep-select">
                            ...
                            <script id="subject2Tmpl" type="text/template">
                                {{~ it:value:index}}
                                <option value="{{=index}}:{{=value.subjectId}}">{{=value.subjectName}}</option>
                                {{~}}
                            </script>
                            <span>老师:</span>
                            <select id="teachers">
                        ...
                        <a href="javascript:;" class="fstep-dc" style="" id="exportClassTeacher">导出学科老师</a>
                    </div>
                ...
                <!--=========================================行政班课表开始===============================================================-->
                <div class="xzb-con" id="tab-XZB" style="display: none;">
                    <div class="fifthstep-title clearfix">
                        <div class="fstep-select">
                            <span>年级:</span>
                            <select id="xzbGradeListCtx"></select>
                            <script id="xzbGradeListTmpl" type="application/template">
                                {{~it:value:index}}
                                <option value="{{=value.id}}">{{=value.name}}</option>
                                {{~}}
                            </script>
                            <span>行政班:</span>
                            <select id="xzbClassListCtx">
                            </select>
                            <script id="xzbClassListTmpl" type="text/template">
                                {{~ it:value:i }}
                                <option value="{{=value.id}}">{{=value.className}}</option>
                                {{~ }}
                            </script>
                        </div>
                        <a href="javascript:;" class="fstep-dc" id="exportClassTable">导出行政班课表</a>
                        <a href="javascript:;" class="fstep-dc">|</a>
                        <a href="javascript:;" class="fstep-dc" id="exportStuTable">导出行政班学生课表</a>
                    </div>
                ...
                <div class="xskb-con" id="tab-XSKB">
                    <div class="fifthstep-title clearfix">
                        <div class="fstep-select">
                            <span>年级:</span>
                            <select id="xsGradeListCtx"></select>
                            <script id="xsGradeListTmpl" type="application/template">
                                {{~it:value:index}}
                                <option value="{{=value.id}}">{{=value.name}}</option>
                                {{~}}
                            </script>
                            <span>行政班:</span>
                            <select id="xsClassListCtx">
                            </select>
                            <script id="xsClassListTmpl" type="text/template">
                                {{~ it:value:i }}
                                <option value="{{=value.id}}">{{=value.className}}</option>
                                {{~ }}
                            </script>
                ...
                <div class="stuset-con" id="tab-ZBSTU">
                    <div class="lsandjs-title">
                        <span>年级:</span>
                        <select id="zbkGradeListCtx"></select>
                        <script id="zbkGradeListTmpl" type="application/template">
                            {{~it:value:index}}
                            <option value="{{=value.id}}">{{=value.name}}</option>
                            {{~}}
                        </script>
...
<script>
    ...
    seajs.use('/static_new/js/modules/zouban/2.0/teacherkebiao.js');
</script>
