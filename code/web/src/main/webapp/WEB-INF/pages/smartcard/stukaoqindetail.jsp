            ...
            <div class="clearfix mykq-nav">
                <ul class="clearfix mykq-ul">
                    ...
                    <c:if test="${roles:isHeadmaster(sessionValue.userRole)}">
                        <li class="mykq-active"><a href="javascript:;">学生考勤详情</a><em></em></li>
                        <li><a href="/smartCard/teaKaoQin.do">老师考勤统计</a><em></em></li>
                    </c:if>
                </ul>
            </div>
            <div class="mykq-mian">
                <p class="stukq-back">&lt;返回班级考勤统计详情</p>
                <input type="hidden" id="userId" name="userId" value="${userId}">
                <input type="hidden" id="gradeId" name="gradeId" value="${gradeId}">
                <input type="hidden" id="gradeName" name="className" value="${gradeName}">
...
<script>
    seajs.use('stukaoqindetail',function (stukaoqindetail) {
