...
<div id="content_main_container">
    <div id="content_main">
        ...
        <div class="course-view-container">
            ...
            <div class="div-gray">
                <span class="span-ps">推送至备课空间</span>
                <span class="span-dl">下载视频</span>
            </div>
                                ...
                                <%--<c:if test="${cw.value5==1}">--%>
                                    <li>
                                        ...
                                        <div class="kjdown">
                                            ...
                                            <a class="o1" cid="${cw.value1}">预览</a>
                                            </c:when>
                                            </c:choose>
                                            <a href="${cw.value}" fnm="${cw.type}" target="_blank">下载</a>
                                        </div>
                                    </li>
                                <%--</c:if>--%>
                            </c:forEach>
    ...
    <%--<div class="push-wind">
        ...
        <div class="push-cont">
            是否选择将视频课程<i>《微课大赛》</i>推送至你的备课空间？
        </div>
        <div class="div-btn">
            <button class="btn-next">下一步</button>
            <button class="btn-x">取消</button>
        </div>
    </div>--%>
    <div class="push-wind">
        <div class="push-top">
        ...
        <div class="push-cont">
           <div class="pushcont-1">
               选择目录
               <div class="push-gray">
                   <span class="span-newfloder">新建文件夹</span>
                   <span class="span-delete">删除</span>
               </div>
           </div>
            <ul class="ul-ml clearfix">
                <li>
                    <div class="ml-title">
                        <span class="tran-ri tran-span"></span>
                        <span class="floder">第一章</span>
                    </div>
                    <ul class="ml-container">
                        <li>
                            <span class="fenzhi"></span>
                            <span class="floder">第一节</span>
                        </li>
                        <li>
                            <span class="fenzhi"></span>
                            <span class="floder">第二节</span>
                        </li>
                        <li>
                            <span class="fenzhi"></span>
                            <span class="floder">第三节</span>
                        </li>
                        <li>
                            <span class="fenzhi"></span>
                            <span class="floder">第四节</span>
                        </li>
                        <li>
                            <div class="ml-title">
                                <span class="tran-ri tran-span"></span>
                ...
                <li>
                    <span class="fenzhi"></span>
                    <span class="floder">第二章</span>
                </li>
                <li>
                    <span class="fenzhi"></span>
                    <span class="floder">第三章</span>
                </li>
                <li>
                    <span class="fenzhi"></span>
                    <span class="floder">第四章</span>
                </li>
            </ul>
        </div>
        <div class="div-btn">
            <button class="btn-next">确认</button>
            <button class="btn-x">取消</button>
        </div>
    </div>
    <%--推送至备课空间弹窗--%>
