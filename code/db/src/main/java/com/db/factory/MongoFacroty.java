    ...
    static {
        try {
           // MongoClientOptions options = MongoClientOptions.builder().connectionsPerHost(500).threadsAllowedToBlockForConnectionMultiplier(500).connectTimeout(1000 * 60 * 10).build();
            MongoClientOptions options = MongoClientOptions.builder().connectionsPerHost(500).threadsAllowedToBlockForConnectionMultiplier(500).maxWaitTime(12*1000).connectTimeout(1000  * 10).socketTimeout(1000 * 10).serverSelectionTimeout(1000 * 10).build();
