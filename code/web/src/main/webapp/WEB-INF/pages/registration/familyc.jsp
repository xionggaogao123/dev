...
<style>
  ...
  .del-family:hover{
    ...
    .grow-tab-head li.cur a {
        background: #0294E2 !important;
        border-top: 1px solid #0294E2 !important;
        border-left: 1px solid #0294E2 !important;
        border-right: 1px solid #0294E2 !important;
        color: #fff !important;
    }
  .grow-tab-head li a {
    ...
    .grow-tab-head {
        border-bottom: #0294E2 1px solid !important;
    }
    .grow-col h4.gray-table-h4 {
        line-height: 40px;
        border: #0294E2 1px solid !important;
...
<!--#foot-->
<!-- 添加家庭成员 -->
<div class="pop-wrap" id="addFalmilyWindow" style="width: 740px;background: #FFF;position: absolute;top: 30px;left: 50%;margin-left: -370px;z-index: 99;">
...
<!-- 添加学习简历 -->
<div class="pop-wrap" id="addStudyHistoryWindow" style="width: 740px;
...
<c:if test="${resumeRole}">
  <!-- 编辑学习简历 -->
  <div class="pop-wrap" id="editStudyHistoryWindow" style="width: 740px;background: #FFF;position: absolute;top: 30px;left: 50%;margin-left: -370px;z-index: 99;">
...
<div class="bg-dialog" style="width: 100%;height: 100%;"></div>
