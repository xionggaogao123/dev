        ...
        <div id="right-container" <%--style="float: none"--%>>
            <div class="main-container">
                ...
                <div class="manage-right-container">
                    ...
                    <!-- 学科列表 -->
                    <div class="list-container subject-list" belong="subject">
...
<script id="subject_tmpl" type="text/template">
    {{for (var i in it) { }}
    <li ty="{{=it[i].subjectType}}" nm="{{=it[i].subjectName}}" sid="{{=it[i].subjectId}}">
        <div class="list-content">
            <span>{{=it[i].subjectName}}</span>
        </div>
        <i class="fa fa-pencil list-edit"></i>
        <i class="fa fa-trash-o list-delete"></i>
    </li>
...
<script>
    seajs.use('/static/js/manage/edu-manage-subject');
</script>
</html>