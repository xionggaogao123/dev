 ...
 */
public class ItemTypeCopyEntry extends BaseDBObject {
    /**
     *
     */
    ...
    public ItemTypeCopyEntry(BasicDBObject baseEntry) {
        super(baseEntry);
    }

    public ItemTypeCopyEntry(int level, ObjectId parentId, String name) {
        this(level,parentId,name,0);
    }

    public ItemTypeCopyEntry(int level, ObjectId parentId, String name, int sort) {
