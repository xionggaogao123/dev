            ...
            success: function (data) {
                ...
                var option = {
                    ...
                    operate: function (totalPage) {
                        ...
                        $('.first-page').attr('onclick', 'getListByType(1,'+pageSize+',\''+schoolId+'\','+'\''+type+'\');');
                ...
                for(var i=0;i<data.pinned.length;i++)
                {
                    ...
                    var infocontent="";
                    infocontent+='<dd>'+
                        '<a href="/customizedpage/hexielu/'+type+'_hexielu.jsp?newsId='+data.pinned[i].id+'">'+content+'</a>'+
                ...
                for(var i=0;i<data.notPinned.length;i++)
                {
                    ...
                    var infocontent="";
                    infocontent+='<dd>'+
                    '<a href="/customizedpage/hexielu/'+type+'_hexielu.jsp?newsId='+data.notPinned[i].id+'">'+content+'</a>'+
