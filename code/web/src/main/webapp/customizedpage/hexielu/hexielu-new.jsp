            ...
            $.ajax({
                ...
                success: function (data) {
                    if (index==1) {
                        ...
                        if (data.code == 200) {
                            window.location = "/customizedpage/hexielu/scheduling.jsp";
    ...
    <div id="login2">
        <div id="logincontent2">
            ...
            <div class="line" style="line-height:30px;">
                ...
                <a <%--href="/customizedpage/hexielu/scheduling.jsp"--%> target="-_blank"><input style="vertical-align:middle;" type="submit" value=" 登 录 " onclick="loginIndex(2);"></a>
            </div>
        </div>
    </div>
</div>
