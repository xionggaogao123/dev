    ...
    <div class="col-right">
        ...
        <div class="cont-right">
            ...
            <div class="right-main">
                ...
                <div class="right-mian2">
                    <div class="main2-div1">
                        <div class="main2-child lie1" >
                            <i clss="main2-i">①</i>
                            <div class="mian2-grandson" id="step01">
                                课程设置
                            </div>
                        </div>
                        <div class="main2-child lie2">
                            <i clss="main2-i">②</i>
                            <div class="mian2-grandson" id="step02">
                                选课进度
                            </div>
                        </div>
                        <div class="main2-child lie3">
                            <i clss="main2-i">③</i>
                    ...
                    <div class="main2-div2">
                        ...
                        <div class="main2-child lie2">
                            <i clss="main2-i">⑤</i>
                            <div class="mian2-grandson" id="step05">
                                冲突检查
                            </div>
                        </div>
                        <div class="main2-child lie3">
                            <i clss="main2-i">⑥</i>
                            <div class="mian2-grandson" id="step06">
                                排课
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-mian3">
                    ...
                    <div class="content">
                        ...
                        <div class="t2">查看学生选课进步，相关教师可以调整学生选课结果；</div>
                    </div>
                    <div class="content">
                        <div class="t1">步骤三：</div>
                        <div class="t2">根据学校的实际情况（1.分段，给年级里所有的班级分成合理的几个分段；2.设置每个走班班级的人数限制；
                            3.如有分层教学，可以按照考试成绩合理分层；4.按照分段和学科自动编班）；</div>
                    </div>
                    <div class="content">
                        <div class="t1">步骤四：</div>
                        <div class="t2">根据分段和科目设置对应的教师和上课教室；</div>
                    </div>
                    <div class="content">
                        <div class="t1">步骤五：</div>
                        <div class="t2">根据分段和教学班查看冲突；</div>
                    </div>
                        <div class="content">
                        <div class="t1">步骤六：</div>
                        <div class="t2">根据学校的实际情况（1设置课表结构；2走班排课；3小走班排课；4体育课排课；非走班排课）；</div>
                    </div>
                    <div class="content">
