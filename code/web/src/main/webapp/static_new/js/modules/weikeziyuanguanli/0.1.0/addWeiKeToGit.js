 ...
 */
/* global Config */
define("addWeiKeToGit",['common','imguploader','videoUploadTwo'],function(require,exports,module){
    /**
     *初始化参数
     */
    var addWeiKeToGit = {},
    ...
    addWeiKeToGit.init = function(){
		...
		addWeiKeToGit.queryAndFill(typeInt);
        ...
        $('#cancelBtn').on('click',function(){
			...
			if(isSaved==0){
				location.href = "/cloud/cloudLessonManage.do";
			}
			if(isSaved==1){
        ...
        $('#commitUploadBtn').on('click',function(){
			...
			addObj.oldVideoId = $('#oldVideoId').val();
	...
	//查询填充上方的东西
	addWeiKeToGit.queryAndFill = function(typeInt){
		var selData={};
