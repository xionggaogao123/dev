        ...
        <div class="stukq-con">
            <div class="clearfix stukq-nav">
                <ul class="clearfix stukq-ul">
                    ...
                    <c:if test="${roles:isHeadmaster(sessionValue.userRole)}">
                        <li class="stukq-active"><a href="javascript:;">班级级考勤统计</a><em></em></li>
            ...
            <div class="stukq-mian">
                ...
                <script type="text/template" id="j-tmpl">
                    ...
                    {{var obj=it.list[i];}}
                    <tr class="user-tr" style="cursor: pointer;" id="{{=obj.classId}}" name="{{=obj.className}}">
...
<script>
    seajs.use('classkaoqin',function (classkaoqin) {
        classkaoqin.init();
    });
</script>
