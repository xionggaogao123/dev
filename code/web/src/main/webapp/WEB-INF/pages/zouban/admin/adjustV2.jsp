...
<head>
    ...
    <!-- Custom styles -->
    <link href="/static_new/css/zouban/adjustV2.css?v=2015041602" rel="stylesheet"/>
                ...
                <div class="tab-linshi">
                    <dl>
                        ...
                        <dd>
                            ...
                            <%--<p>提示：走班课调整将附带调整整个段内的班级课表，请谨慎调课！</p>--%>
                                ...
                                <div class="adjust-mian-right Rclass-main-right">
                                    ...
                                    <script type="application/template" id="tableTempJs2">
                                        ...
                                        <tr>
                                            ...
                                            {{?value2.type==0}}<%--type:0走班 2非走班 3无课--%>
                                                {{?value2.week==0}}<%--0可以点击 1不可点击--%>
                                                <td class="Rclass-main-ZB ZB_table_base zoubanDel" x="{{=value1}}" y="{{=index+1}}">
                                                {{??value2.week==1}}
...
<script>
    seajs.use('adjustV2', function(adjust) {
        adjust.init();
    });
</script>
</body>
