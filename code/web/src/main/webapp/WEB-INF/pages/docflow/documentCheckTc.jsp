        ...
        <div class="tab-col">
            <div class="tab-head clearfix">
                ...
                <script type="application/template" id="unReadCountJs">
                    <li>
                        <a href="/docflow/documentList.do?type=0&version=51&a=10000">公文</a>
                        {{?it.unread>0}}
                        <span>
                            {{=it.unread}}
                        </span>
                    ...
                    <li class="cur">
                        <a href="/docflow/documentList.do?type=1&version=51&a=10000">审阅</a>
                        {{?it.uncheck>0}}
                        <span>{{=it.uncheck}}</span>
                        {{?}}
                    </li>
                    <li>
                        <a href="/docflow/documentList.do?type=2&version=51&a=10000">我的公文</a>
                        {{?it.promote>0}}
            ...
            <div class="tab_main">
                <a href="/docflow/documentList.do?type=1&version=51&a=10000" class="Bk"> < 返回</a>
                <a href="/docflow/documentModify.do?docId={{=it.id}}&type=1&version=51&a=10000" id="goToHref" class="tab-XG">修改原文</a>
