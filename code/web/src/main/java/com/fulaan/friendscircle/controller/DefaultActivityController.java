...
@Controller
@RequestMapping("/jxmapi/activity")
public class DefaultActivityController extends BaseController {

    private static final Logger logger = Logger.getLogger(DefaultActivityController.class);
    @Resource
