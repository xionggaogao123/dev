                        ...
                        <div id="account-right-title">
                            <div id="account-r-sel">
                                <a href="/basic" target="_self"
                                   style="color: #fcbc5e!important;border: 1px solid #848484!important;border-bottom: 1px solid white!important;width: 100px!important;height: 26px!important;margin-top: -7px!important;line-height: 24px!important;background: white;display: inline-block!important;z-index: 999999999999;">基本信息</a>
                                ...
                                <table class="account-tb">
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="userName" type="text" name="" id="userName"
                                                   style="border:1px solid #CCC; height: 20px;padding: 2px;width: 200px"
                                                   value="${loginName}"/>
                                        </td>
                                        <td>可用于账号登录</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input id="verifyCode" type="text" name=""
                                            ...
                                            <img id="imgObj" alt="" src="/verify/verifyCode.do"
                                                 style="position: relative;top: 7px;left: 2px" onclick="changeImg()"/>
                                        </td>
                                        <td></td>
                                    </tr>
