...
<head>
  ...
  <script type="text/javascript" src="/static_new/js/modules/yunying/0.1.0/emark.js"></script>
...
<div id="content_main_container" style="width:1200px;position: relative;background-color: white; overflow: hidden;margin:0 auto;">
  <%@ include file="../common_new/col-left.jsp" %>
  <div id="content_main" style="overflow: visible">
    <!-- 左侧导航-->
    ...
    <!-- left end -->
    <!-- right start-->
    <div id="right-container" style="padding-left:15px;padding-top:10px;">
      <div class='center-container select-course' style="margin-top: 8px;width: 950px;">
      ...
      <div id="y_courses_container" style="overflow: visible">
        <div id="y_courses" class='center-container' style="min-height:500px;margin-left: 180px;">
        </div>
...
<div id="select-course" style="display:none;">
  ...
  <div class="course-type">
    ...
    <div class="retrieval-subject" id="retrieval-subject">
      <div class="subject-title">科目</div>
