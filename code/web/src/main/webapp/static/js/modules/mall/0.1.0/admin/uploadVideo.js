...
define(function (require, exports, module) {
    ...
    uploadVideo.init = function (page) {
        $('#listCtx').empty();
        Common.getData('/admin/video.do', {page: page, pageSize: 20}, function (data) {
            Common.render({
                tmpl: $('#listJS'),
                data: data.videoList,
                context: '#listCtx'
        ...
        $('#category').empty();
        Common.getData('/admin/eGoodsCategorys.do', {}, function (data) {
            Common.render({
                tmpl: $('#categoryJS'),
                data: data,
                context: '#category'
