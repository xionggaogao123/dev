...
<head>
   ...
   <script type="text/javascript" src="/static/js/cloudclass.js"></script>
    ...
    {
    	location.href="/notice/index.do?version=3&index=2&page="+page;
    }
    </script>
</head>
<body>
...
<div class="inform-main">
    <div class="inform-top">
        <div class="inform-top-I" id="new-inform">
            ...
            <span><a href="/notice/create.do">发布新通知</a></span>
            </c:if>
            <!--====================发送中==============================-->
            <%--<span>1封邮件正在发送....</span>--%>
            <!--======================发送===========================-->
        ...
        <div class="inform-top-II">
            <span class="inform-TJ">通知列表</span>
    ...
    <div class="compile-main" id="compile_in">
        ...
        <div class="valid-time">
            ...
            <span>有效时间是同步到日历中显示的时间，有效时间过后通知中自动显示为失效时间</span>
        </div>
	            ...
	            <div>
	                ...
	                <div class="inform-li-right">
	                     ...
	                     <c:if test="${notice.already==0 }">
	                      <span class="inform-see inform-YC" id="infrom-delete" onclick="detail('${notice.id}')">查看</span>
	                     </c:if>

                         <c:if test="${notice.isSelfOper!=1 }">
                             <c:if test="${roles:isHeadmaster(sessionValue.userRole)||(roles:isManager(sessionValue.userRole)&&roles:isTeacher(sessionValue.userRole))}">
                    ...
                    <div style="float: right">
                        ${notice.alreadyCount }人查看/共${notice.totalCount }人
                    </div>
	            </div>
	        </li>
        </c:forEach>
