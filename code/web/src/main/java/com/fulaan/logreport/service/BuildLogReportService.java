package com.fulaan.logreport.service;
...
import com.fulaan.logreport.dto.CountDTO;
import com.fulaan.logreport.dto.LogReportDTO;
...
public class BuildLogReportService {
    ...
    private List<LogReportDTO> getLogReportDataProcess(long dateStart, long dateEnd){
        ...
        for(SchoolEntry scEntry:schoolList){
            ...
            Map<String,List<ObjectId>> userMap = userService.getRoleUserIdMapBySchoolId(scEntry.getID().toString());
