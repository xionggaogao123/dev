...
(function ($, window, document, undefined) {
    ...
    function init(target, options) {
        ...
        ////初始化各个组件
        //var $msb_main = "<a class='msb_main'><img title='分享' src='/static/images/forum/share_core_square.jpg'></a>";
        ...
        //});
        ////添加qq好友分享事件
        //$(document).on("click",".msb_network_button.friendQQ",function(){
        //	qqShare(this,settings);
        //});
    ...
    function qqShare(target, options) {
        window.open(replaceAPI(qqfriend, $.extend({}, $.fn.socialShare.defaults, options)));
    }
