...
<body>
<!-- user info start -->
<%@ include file="../common/flippedhead.jsp" %>
                    ...
                    <div id="account-right">
                        ...
                        <div id="account-right-content" class="account-right-content" style="max-height: 800px;">
                            ...
                            <div id="headmaster-help-container" class="help-container">
                                ...
                                <div style="font-size: 20px;font-weight: bold;overflow: visible;width:100%;height: 80px;line-height: 40px;text-align:center;">
                            ...
                            <div id="teacher-help-container" class="help-container">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-fbtz1.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-fbtz2.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <span class="tip-tw">
                                           3.如何在好友圈组织活动？
                                    ...
                                    <li>
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-scsp1.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-scsp2.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div>
                                            <pre><span class="tip-c">其次上传课件： </span>包括任务单，讲义等，不局限格式，可供学生下载使用。</pre>
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-scbpz.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div>
                                            <pre>之后会跳转到课程编辑页面，点击页面最下方的“保存”就可完成课程制作。</pre>
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-kckj1.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-kckj2.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <span class="tip-tw">
                                          5.如何借鉴校本资源和联盟资源课程？
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-xxtj2.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-xxtj3.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-dyqk1.jpg" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-dyqk2.jpg" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-cjlr2.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <div class="tip-uim">
                                            <img src="/img/userhelp/images/tip-cjlr3.png" alt="" class="I_I"
                                                 width="750">
                                        </div>
                                        <span class="tip-tw">
                                          8.如何进行报修管理？
