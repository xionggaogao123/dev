...
<style type="text/css">
    ...
    .lxfscroll-title {width: 400px !important;position: relative!important;top: -30px!important; right: -515px!important;}
    ...
    .cur { color: #FFF; font-weight: bold; background:#666; }.lxfscroll ul { position: absolute; width: 4770px; }
...
<div class="homepage-right-top" style="overflow: visible">
    <div class="homepage-img-right-left" style="overflow: hidden!important;width:680px;float: left;height: 100px">
        <div class="lxfscroll">
            <ul id="ulObj">
    ...
    <div style="overflow: visible;/*float: left;*/">
        <a href="/petbag" target="_blank">
            <img  id="petImage" class="homepage-img-right-right" style=" width:100px; height:100px;cursor: pointer" src="/img/egg.png">
        </a>
