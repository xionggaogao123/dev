...
public class EvaluationItemDao extends BaseDao {
     ...
     * @return
     */
    public EvaluationItemEntry getEvaluationItem(ObjectId teacherId, ObjectId schoolId, String year, DBObject fields) {
        DBObject query = new BasicDBObject("tid", teacherId).append("si", schoolId).append("y", year);
        DBObject dbObject = findOne(MongoFacroty.getAppDB(), COLLECTION_NAME, query, fields);
        if (dbObject != null) {
            return new EvaluationItemEntry((BasicDBObject) dbObject);
        }
    ...
    public List<EvaluationItemEntry> getEvaluationItems(Collection<ObjectId> teacherIds, ObjectId schoolId, String year, DBObject fields) {
        List<EvaluationItemEntry> evaluationItemEntries = new ArrayList<EvaluationItemEntry>();
        DBObject query = new BasicDBObject("tid", new BasicDBObject(Constant.MONGO_IN, teacherIds)).append("si", schoolId).append("y", year);
    ...
    public List<EvaluationItemEntry> getEvaluationItems(ObjectId schoolId, String year, DBObject fields) {
        List<EvaluationItemEntry> evaluationItemEntries = new ArrayList<EvaluationItemEntry>();
     ...
     * @param value
     */
    public void updateEvaluationItem(ObjectId teacherId, ObjectId schoolId, String year, DBObject value) {
        DBObject query = new BasicDBObject("tid", teacherId).append("si", schoolId).append("y", year);
     ...
     * @param year
     */
    public void restEvaluationItemScore(ObjectId schoolId, String year) {
        DBObject query = new BasicDBObject().append("si", schoolId).append("y", year);
