                    ...
                    <dl>
                        <dd>
                         ...
                         <%--   <!--===================资源中心==========================-->
                            ...
                            <%--只为复兰大学显示--%>
                            <c:choose>
                                <c:when test="${sessionValue.getSchoolName()=='复兰大学'}">
                                    <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover">
                                        <img class="" src="../../customizedpage/newspage/img/newLogoo-23-H.png">
                                        <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
                                    </a>
                                    <a href="http://139.196.198.137:8081/videoPage3" class="newPage-right-pagevieww">
...
<%--<div class="student-main" style="display: none;">--%>
    <%--<div>--%>
        ...
        <%--<!--论坛君-->--%>
        <%--<a class="student-main-I" href="www.fulaan.com/forum/index.do" target="_blank"></a>--%>
        <%--<!--大赛君-->--%>
        <%--<a class="student-main-II" href="www.fulaan.com/forum/competition.do" target="_blank"></a>--%>
        <%--<!--www.fulaan.com-->--%>
        <%--<a class="student-main-III" href="www.fulaan.com" target="_blank"></a>--%>
        <%--<!--关闭按钮-->--%>
