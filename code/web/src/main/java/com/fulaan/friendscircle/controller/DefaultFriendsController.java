...
@Controller
@RequestMapping("/jxmapi/friendcircle")
public class DefaultFriendsController extends BaseController {

    private static final Logger logger = Logger.getLogger(DefaultFriendsController.class);
