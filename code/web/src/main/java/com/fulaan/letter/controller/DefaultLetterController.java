...
@Controller
@RequestMapping("/jxmapi/letter")
public class DefaultLetterController extends BaseController {

    private static final Logger logger = Logger.getLogger(DefaultLetterController.class);
