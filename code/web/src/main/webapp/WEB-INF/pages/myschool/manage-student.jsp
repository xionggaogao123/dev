        ...
        <div id="right-container">
            <div class="main-container">
                ...
                <div class="manage-right-container">
                    ...
                    <!-- 各班列表 -->
                    <div class="list-container pre-class-list" belong="pre-class" style="overflow: hidden;">
                        ...
                        <div class="batch-export"  style="display:none"><i class="fa"></i> 批量导入老师</div>
                        <ul class="list-ul class-teacher-list">
                            <li>
                                ...
                                <i class="fa fa-trash-o list-delete list-li"></i>
                            </li>
                        </ul>
                        <div class="list-class-add class-add-student"><i class="fa fa-plus"></i> 新建学生</div>
                        <div class="batch-export"  style="display:none"><i class="fa"></i> 批量导入学生</div>
