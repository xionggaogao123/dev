...
public class ZoubanStateDao extends BaseDao {
     ...
     * @return
     */
    public ZoubanState findZoubanState(ObjectId schoolId, ObjectId gradeId, String term) {
     ...
     * @param state
     */
    public void setGradeState(ObjectId schoolId, ObjectId gradeId, String term, int state) {
        BasicDBObject query = new BasicDBObject()
                .append("te", term)
                .append("sid", schoolId)
                .append("gid", gradeId);
     ...
     * @param state
     */
    public void setGradeSubState(ObjectId schoolId, ObjectId gradeId, String term, int state) {
        BasicDBObject query = new BasicDBObject()
                .append("te", term)
                .append("sid", schoolId)
                .append("gid", gradeId);
