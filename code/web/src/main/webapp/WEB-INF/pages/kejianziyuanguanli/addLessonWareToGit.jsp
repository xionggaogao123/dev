            ...
            <div class="add-ziyuan-col">
                ...
                <div class="form-col">
                    ...
                    <div class="form-main clearfix complex-value-class">
                        ...
                        <input id="subjectType" type="hidden" value="${dto.subjectName}"/>
                        <input id="bookVertion" type="hidden" value="${dto.bookType}"/>
                        <input id="gradeType" type="hidden" value="${dto.gradeName}"/>
                        <input id="chapterType" type="hidden" value="${dto.chapterName}"/>
                        <input id="partType" type="hidden" value="${dto.partName}"/>
...
<script>
    seajs.use('addLessonWareToGit',function(addLessonWareToGit){
