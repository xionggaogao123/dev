...
@Controller
@RequestMapping("/jxmapi/community")
public class DefaultCommunityController extends BaseController {
    ...
    public RespObj joinCommunity(@ApiParam(name="communityId",required = true,value = "社区Id")@ObjectIdType ObjectId communityId,
        ...
        if (dto.getOpen() == 1) {
            ...
            if (memberService.isGroupMember(groupId, userId)) {
                ...
                ext.put("userId", "575e21be0cf2a633a9ff7b6b");
                ...
                if (flag) {
                    if(emService.sendTextMessage("users", targets, "575e21be0cf2a633a9ff7b6b", ext, sendMessage)){
