...
<head>
    ...
    <script type="text/javascript" src="/customizedpage/fuyang21/js/fuyang21.js"></script>
    <!--[if IE 6]>
...
<div class="middle_info">
    <dl>
        <dt><a href="/customizedpage/fuyang21/flippedClassroom.jsp">首页</a>&nbsp;>&nbsp;<span id="fuyang21_type">新闻首页</span></dt>
        <dd>
            <table>
                <tr>
                    <!--==============================左边部分==============================-->
                        ...
                        <div class="middle_right_I middle_right_II">
                            <div>
                                ...
                                <dl class="recent_notice">
                                    ...
                                    <%--<dd>
                                        <a>爱丽丝的飞机拉开就是地方了卡健身拉了分开就阿里上看见对方了卡机斯蒂芬李会计爱丽丝的疯狂就拉斯加对方离开房</a>
                                        <i>2015年06月30日</i>
                                    </dd>--%>
                                </dl>
                                <!--分页-->
