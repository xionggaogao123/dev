...
function getAllExcellent(data){
    ...
    for(var i = 0; i < course.length; i ++){
        ...
        //if(course[i].isopen == '1'){
            personInfo = '<div class="course-ownner ellipsis" title="'+ course[i].user.value +'">'+ course[i].user.value +'<button style="width: 30px;height: 20px;position: absolute;margin-left: 85px;line-height: 6px;" onclick="deleteEmarkLesson(\''+course[i].id+'\');">'+'删除</button></div>'+
        ...
        //}
        html += '<div class="col-xs-3 subject-container">'+
        '<div class="subject-img-container"  onclick="showBugPage(\''+course[i].lessonid+'\');">'+
...
function showBugPage(courseId){
    window.location.href='/lesson/view.do?lessonId='+courseId;
}
var currentpage = 1;
