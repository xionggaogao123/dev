...
<head>
  ...
  <script type="text/javascript" src="/static_new/js/modules/core/0.1.0/jquery.min.js?v=1"></script>
    <style>
        ...
        .tab-head li.cur {
            border-top:4px solid #0294E2 !important;
        }
        .tab-head li a:hover{
            color:#333;
        }
        .tianjian-btn ul li.cur {
            background: #0294E2;
        }
        .charts-list .charts-height {
    ...
    <div class="tab-col">
      ...
      <div class="tab-head clearfix">
        <ul class="teachermain-cur">
          ...
          <li><a href="/score/header/semester.do?a=10000">学期成绩</a></li>
        </ul>
      ...
      <div class="tab-main">
        ...
        <div id="noExam" style="color:#FF0000;display: none;padding: 10px;">暂无考试信息！</div>
        <!--/.charts-col-->
