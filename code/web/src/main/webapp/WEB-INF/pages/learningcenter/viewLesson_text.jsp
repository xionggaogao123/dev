...
<div id="content_main_container">
    <div id="content_main">
        ...
        <div class="course-view-container">
            ...
            <div  style=";height:400px;border:5px solid #ddd;background: #ffffff;margin-top: 10px;overflow-y: auto;word-break: break-all;display: block;padding: 10px;font-size: 16px;">
               ${text_content}
            </div>
