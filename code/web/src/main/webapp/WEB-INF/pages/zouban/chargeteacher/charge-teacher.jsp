    ...
    <div class="col-right">
        ...
        <div class="cont-right">
            ...
            <div class="right-main1">
                <div class="main1-1">
                    <span class="termShow">2015-2016学年xxx学期</span>
                </div>
                <div class="main1-2">
            ...
            <div class="right-main2">
                <div class="main2-1">
                    <span class="termShow">2015-2016学年&nbsp;xxx学期</span>
                </div>
                <div class="main2-2">
                    <em>科目</em>
...
<div class="main3-hide2">
    ...
    <div class="hide4-2">
        <em class="termShow">2015-2016学年&nbsp;第一学期</em> <i id="subjectName">物理</i>
    </div>
    <table class="hide4-3">
