/**
 * Created by guojing on 2015/11/11.
 */
define('manageCountUtils',['jquery'],function(require,exports,module){
    /**
     *初始化参数
     */
    var Util = {};
    ...
    Util.buildChartData = function (type, subtype, rawdata){
        var charData;
        if(type == 'gltj_fwfx') {
            charData = {
                title: {
            ...
            if(subtype=='ryfb'){
                ...
                charData = {
                    ...
                    legend: {
                        ...
                        y: 10,
                        itemGap: 14,
                        data: [ rawdata.student + '%学生', rawdata.parent + '%家长'],
                        textStyle: {fontSize: 12},
                        itemWidth: 0,
                        itemHeight: 0
                    },
                ...
                charData = {
                    ...
                    series: [

                        {
                            ...
                            type: 'bar',
                            itemStyle: itemStyle,
                            data: [rawdata.scount, rawdata.pcount]
                        }
                    ]
                };
            }
