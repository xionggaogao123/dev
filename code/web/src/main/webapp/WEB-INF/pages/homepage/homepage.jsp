...
<div id="content" class="clearfix">
  ...
  <!--.col-right-->
  <div class="col-right">
    <%--<input type="hidden" value="${sessionValue.userJinyan}" id="jinyan">--%>
    <!--.banner-info-->
    ...
    <div class="coottop clearfix">
      <div class="tab-col">
        <div class="tab-head clearfix">
          <ul>
            <li class="cur"><a href="javascript:;" class="title">微校园</a></li>
          </ul>
        </div>
        <div id="tab_Main">
          <div class="tab-main">
            ...
            <textarea  id="micoblog_content" placeholder="来说一句" class="phd"></textarea>
            <div class="upload-info clearfix">
                            <%--<span class="icontu">--%>
                            <%--图片--%>
                            <%--<input type="file" id="upload" name="f" size="1" />--%>
                            <%--</span>--%>
                            ...
                            <%--<input type="file" id="upload"  name="f" size="1" />--%>
                              ...
                              <%--<label id="upload-img" for="image-upload"  style="cursor:pointer;">--%>
                                <%--<img src="/static_new/images/iconvideo.jpg" class="upload-blog-image" alt="" title="上传视频">--%>
                                <%--<span class="upload-image">视频</span>--%>
                              <%--</label>--%>
                            <span class="HUA">
                                ...
                                <div class="huati">
                                  ...
                                  <i class="i_hua"></i>
                                  <%--<div class="tra">--%>
                                    <%--<textarea class="tra1" placeholder="#插入话题"></textarea>--%>
                                  <%--</div>--%>
                                  <ul class="themeUl2">
                                  </ul>
            ...
            <script type="text/template" id="hwk1_templ">
              ...
              <div class="list-info clearfix" mid="{{=obj.id}}">
                ...
                <div class="list-txt">
                  ...
                  {{?}}</h4>
                  {{?obj.blogcontent.length>100}}
                  <div class="info-content contentHidden">
                    {{=obj.blogcontent.substring(0, 105)}}...<a class="zhankai" concent="{{=obj.blogcontent}}">展开</a>
                  </div>
                  {{??}}
      ...
      <script type="text/template" id="hwk2_templ">
        ...
        <div class="clearfix bomt">
          ...
          <dd class="clearfix">
            ...
            <a href="javascript:;"class="lanname">{{=obj.username}}</a>
            <span>:</span>
            <div class="neirong">
              {{=obj.blogcontent}}
            </div>
