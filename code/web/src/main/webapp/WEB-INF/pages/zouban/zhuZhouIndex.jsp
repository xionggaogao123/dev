            ...
            <div class="right-main">
                ...
                <div class="right-mian2-gezhi">
                    ...
                    <div class="main2-div2">
                        <div class="main2-child lie1 v6">
                            <i clss="main2-i">④</i>
                            <div class="mian2-grandson" id="step06">
                                排课
                            </div>
                        </div>
                        <div class="main2-child lie2 v7">
                            <i clss="main2-i">⑤</i>
                            <div class="mian2-grandson" id="viewTable0" >
                                发布课表
                            </div>
                        </div>
                        <div class="main2-child lie3 v8">
                            <i clss="main2-i">⑥</i>
                       ...
                       <%-- <div class="main2-child lie3">
                            <i clss="main2-i">⑥</i>
                            <div class="mian-grandson" id="adjsutCourse" style="margin-top: 4px;">
                                调课
                            </div>
                        </div>--%>
                ...
                <div class="right-mian3">
                    ...
                    <div class="content">
                        ...
                        <div class="t2">根据需要手动修改非走班课程老师；</div>
                    </div>
                    <div class="content">
                        <div class="t1">步骤四：</div>
                        <div class="t2">根据学校的实际情况排课（1设置课表结构；2走班排课；3非走班排课）；</div>
                    </div>
                    <div class="content">
                    ...
                    <div class="content">
                        ...
                        <div class="t2">根据需要，对非走班课程进行适当调整。</div>
                    </div>
                </div>
