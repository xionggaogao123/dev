                    ...
                    <div class="col-md-8" style="border-right:1px solid #aaa;border-left:1px solid #aaa;">
                        <div style="color:#E43838">
                            ...
                            <div class="alert alert-danger" role="alert">
                                <t1 style="font-size:25px">注意：本页面所有价格单位为分！！！！！！！！！！<br>例如1元表示为100<br>123.45元表示为12345
                                </t1>
                            </div>
                        ...
                        <table ng-controller="myCtrl" class="table table-bordered table-hover">
                            <tr>
                                <td>商品ID</td>
                                <td><input id="goodsId" ng-model="goods.goodsId">
                                    <button id="getGoods" ng-click="getGoods()">获取商品信息</button>
                                </td>
                            </tr>
                            <tr>
                                <td>商品名</td>
                                <td><textarea id="goodsName" style="height: 100px;width: 500px;"
                                              ng-model="goods.goodsName" required="required"></textarea></td>
                            </tr>
                            <tr>
                                <td>品牌</td>
                            ...
                            <tr>
                                <td>介绍</td>
                                <td><textarea id="introduce" style="height: 100px;width: 500px;"
                                              ng-model="goods.introduction"></textarea></td>
                            </tr>
                            <tr>
                                <td>基础价格</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="expressTemplate" ng-model="goods.expressTemplateId" required="required">
                                        <option ng-repeat="expressTemplate in expressTemplateList"
                                                value="{{expressTemplate.id}}">{{expressTemplate.name}}
                                        </option>
                                    </select>
                            ...
                            <tr>
                                <td>产品分类</td>
                                <td>
                                    <select ng-model="goods.goodsCategoryList" multiple required="required"
                                            id="category">
                                        <option ng-repeat="goodsCategory in goodsCategoryList"
                                                value="{{goodsCategory.id}}">{{goodsCategory.name}}
                                        </option>
                                    </select>
                                    <select ng-model="goods.levelGoodsCategoryList" multiple required="required" hidden
                                            id="levelCategory">
                                        <option ng-repeat="levelGoodsCategory in levelGoodsCategoryList"
                                                value="{{levelGoodsCategory.id}}">{{levelGoodsCategory.name}}
                                        </option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select ng-model="goods.gradeCategoryList" multiple>
                                        <option ng-repeat="gradeCategory in gradeCategoryList"
                                                value="{{gradeCategory.id}}">{{gradeCategory.name}}
                                        </option>
                                    </select>
                            ...
                            <tr>
                                <td>积分类型</td>
                                <td>
                                    <select id="maxOut" ng-model="goods.maxOut" required="required">
                                        <option value="-1"></option>
                            ...
                            <tr>
                                <td>销售数量</td>
                                <td><input id="sellCount" readonly ng-model="goods.sellCount"
                                           style="background-color:#999"></td>
                            </tr>
                            <tr>
                                <td>人气</td>
                                <td><input id="popular" readonly ng-model="goods.popularLevel"
                                           style="background-color:#999"></td>
                            </tr>
                            <tr>
                                <td>评价总计</td>
                                <td>
                                    <span>5颗星</span><input class="cs5" readonly
                                                           ng-model="goods.commentSummary[0].value"><br>
                                    <span>4颗星</span><input class="cs4" readonly
                                                           ng-model="goods.commentSummary[1].value"><br>
                                    <span>3颗星</span><input class="cs3" readonly
                                                           ng-model="goods.commentSummary[2].value"><br>
                                    <span>2颗星</span><input class="cs2" readonly
                                                           ng-model="goods.commentSummary[3].value"><br>
                                    <span>1颗星</span><input class="cs1" readonly
                                                           ng-model="goods.commentSummary[4].value"><br>
                                </td>
                            </tr>
                            <tr>
                                <td>规格</td>
                                <td>
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <button id="addKind" ng-click="addKind()">增加</button>
                                            </td>
                                            <td align="center">
                                                <button id="deleteKind" ng-click="deleteKind()">减少</button>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <button class="btn btn-primary" style="position: absolute;left: 40%;" id="submit"
                                            ng-click="submit()">提交
                                    </button>
...
<script src="/static/js/modules/mall/0.1.0/admin/upsetGoods.js"></script>
