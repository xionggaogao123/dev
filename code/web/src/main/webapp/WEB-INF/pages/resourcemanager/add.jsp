        ...
        <div class="add-ziyuan">
            ...
            <div class="form-col">
                ...
                <div  class="form-main uploader-info">
                 ...
                 <form id="resForm" action="/cloudres/manager/addCourseware.do" method="post" enctype="multipart/form-data">
                    
                    <input id="verStr" name="verStr" type="hidden"/>
                    <input id="knoStr" name="knoStr" type="hidden"/>
                    ...
                    <div class="btn-list">
                        <button type="button" id="commitUploadBtn">上传</button>
