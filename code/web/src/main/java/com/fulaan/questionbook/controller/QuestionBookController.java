...
public class QuestionBookController extends BaseController {
    ...
    @ResponseBody
    public String addQuestionBookEntry(@ApiParam(name="dto",required = true,value="作业对象") @RequestBody QuestionBookDTO dto,
                                       @ApiParam(name="answerContent",required = true,value="答案内容") @RequestParam(value="answerContent") String answerContent,
                                       @ApiParam(name="answerList",required = true,value="答案图片") @RequestParam(value="answerList") List<String> answerList,
                                       @ApiParam(name="analysisContent",required = true,value="解析内容") @RequestParam(value="analysisContent") String analysisContent,
                                       @ApiParam(name="analysisList",required = true,value="解析图片") @RequestParam(value="analysisList") List<String> analysisList){
