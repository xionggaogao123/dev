...
<script>
    ...
    (function () {
        ...
        hm.src = "//hm.baidu.com/hm.js?ee3df5d55d6eb1014d89f23163765c9d";
...
<div class="store-foott">
    <div class="store-foott-main" style="width: 1250px;">
        <div class="store-foott-left">
            ...
            <span>
                ...
                <a href='http://wpa.qq.com/msgrd?v=1&uin=2803728882&site=qq&menu=yes'
                   style="position: relative;top: 5px;" target="_blank"><img src="/static/images/QQService.png"></a>
            </span>
            <span>沪ICP备14004857号</span>
        </div>
        <div class="store-foott-right">
            <div>
                <img src="/static/images/store-WEII.jpg">
                <p class="p1">
                    微信、微博欢迎<br>搜索关注“复兰科技”<br>
                </p>
                <a target="_blank" href="http://weibo.com/FulaanTechnology"><img src="/static/images/store-WEB.png"></a>
                <a target="_blank" href="http://t.qq.com/FulaanTechnology"><img src="/static/images/store-WEBI.png"></a>
            </div>
            <div>
                <img src="/static/images/forum/store_erw.png">
                <p class="p2">复兰教育社区客户端</p>
                <img src="/static/images/forum/fotter_iosand.png">
            </div>
        </div>
    </div>
</div>
