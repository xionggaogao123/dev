      ...
      //下拉菜单查询填充方法
       ...
       //置空弟弟们
        ...
        function queryList(pageNo){
        	...
        	$.ajax({
        		type: "POST",
                url: "/cloudres/manager/dtolist.do",   
                data: queryObj,
                dataType: "json",
                success: function(data){
...
//          	            	alert('当前第' + n + '页'); 
      ...
      //绑定编辑课件资源方法
        $('body').on('click','.edit-page-btn',function(){
        	location.href = "/cloudres/manager/edit.do?id=" + $(this).closest('tr').attr('flag') + "&paramFileId=" + $(this).closest('tr').attr('fileId');
        });
