...
<div class="middle_info">
    <dl>
        <dt><a href="/customizedpage/fuyang21/flippedClassroom.jsp">首页</a>&nbsp;>&nbsp;<a href="/customizedpage/fuyang21/fuyang21.jsp?type=news">新闻首页</a></dt>
        <dd>
            <table>
                <tr>
                    <!--==============================左边部分==============================-->
                    <td>
                        <div class="middle_left">
                            <ul>
                                <li><a href="/customizedpage/fuyang21/fuyang21.jsp?type=notice">公告</a></li>
                                <li><a href="/customizedpage/fuyang21/fuyang21.jsp?type=news" class="cur">新闻</a></li>
                            </ul>
                        </div>
                    </td>
                    <!--==============================公告部分==============================-->
                        ...
                        <div class="news_line">
                            <dl class="news_right">
                                ...
                                <div class="news_main_f">
                                    <a href="fuyang21.jsp">< 返回首页新闻</a><i>下一条 ></i><i>< 上一条</i>
                                </div>
                            </dl>
                        </div>
                    </td>
