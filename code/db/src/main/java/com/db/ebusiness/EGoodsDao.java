...
public class EGoodsDao extends SynDao {
     ...
     * @return
     */
    public List<EGoodsEntry> getEGoodsEntrys(DBObject fields, DBObject sort, int state, int activity, int groupPurchase, int maxOut, ObjectId goodsCategoryId, ObjectId levelGoodsCategoryId,
     ...
     * @return
     */
    public int getEGoodsEntrysCount(int state, int activity, int groupPurchase, int maxOut, ObjectId goodsCategoryId, ObjectId levelGoodsCategoryId, Set<ObjectId> gradeCategorySet, int bookCategory, int[] priceArr, String regular) {
        BasicDBObject query = new BasicDBObject("st", state);
        if (goodsCategoryId != null) {
            query.append("gcl", goodsCategoryId);
        }
