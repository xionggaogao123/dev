...
<body>
<div id="schoolid" style="display: none;">${schoolid}</div>
<!--=================================引入头部============================================-->
...
<div class="student_infromation_main">
  <div style="width:1000px; margin: 0 auto; overflow: hidden; ">
    ...
    <div class="right" style="width: 980px;">
      <div class="right_top">
        <p>
          <a href="javascript:;" class="current" style="width: 130px;">平台使用统计</a><a href="javascript:;" style="width:130px;" onclick="location.href='/manageCount/functionUse.do?a=10000&schoolId=${schoolid}'">平台功能统计</a>
        </p>
        <div class="select">
          ...
          <select id="grade-search" style="width:100px;">
      ...
      <div class="tongji1">
        ...
        <div class="fangwen">
          ...
          <div class="zhexian1" id="main1" style="width: 960px;"></div>
          <div class="zhexian2">
            <div class="zhexian2_1" id="main2"></div>
            <div class="zhexian2_2" id="main3" style="width: 580px;"></div>
          </div>
          <div class="touxiang">
            <div class="bot" style="width: 310px;">
              <dl>
      ...
      <div class="tongji2">
        ...
        <div class="fangwen" style="margin-bottom:9px;">
          ...
          <div class="zhexian2" id="main4" style="width: 960px;"></div>
          <div class="touxiang">
            <div class="bot" style="width: 440px;">
              <dl>
        ...
        <div class="fangwen">
          ...
          <div class="zhexian2" id="main5" style="width: 960px;"></div>
          <div class="touxiang">
            <div class="bot" style="width: 440px;">
              <dl>
      ...
      <div class="tongji3" style="border-bottom:none;">
        ...
        <div class="fangwen">
          ...
          <div class="zhexian2" id="main6" style="width: 960px;"></div>
          <div class="touxiang">
            <div class="bot" style="margin-left: 140px;">
              <dl>
  ...
  <script>
    seajs.use('totalpage',function(totalpage){
      totalpage.init();
    });
  </script>
</body>
