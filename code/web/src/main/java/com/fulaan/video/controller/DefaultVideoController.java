 ...
 */
@Controller
@RequestMapping("/jxmapi/video")
public class DefaultVideoController extends BaseController {

    private VideoService videoService = new VideoService();
    private static final Logger logger = Logger.getLogger(DefaultVideoController.class);
