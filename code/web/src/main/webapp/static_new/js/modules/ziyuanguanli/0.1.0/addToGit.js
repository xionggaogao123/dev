    ...
    addToGit.init = function(){
        ...
        function findAndFillEmptySelection(){
        	...
        	for(var i = 0;i < allVersionRootSelections.length;i++){
        		...
        		if(subKnowledgeSelection.find("option").length == 0){
...
//        	var $selection = $("#" + selectionId);
       ...
       //置空弟弟们
        ...
        $('#cancelBtn').on('click',function(){
        	location.href = "/courseware/list.do"; 
        })
        ...
        $('#commitUploadBtn').on('click',function(){
        	...
        	if(isCourseware){
        		$.ajax({
            		type: "POST",
                    url: "/courseware/updateCourseware.do",  
                    data: addObj,
                    dataType: "json",
                    success: function(data){
                    	if(data.code == "200"){
                    		$.ajax({
                        		type: "POST",
                                url: "/courseware/addCoursewareToGit.do",  
                                data: {id : PUBLIC_ID},
                                dataType: "json",
                                success: function(data){
                                	if(data.code == "200"){
        		...
        		$.ajax({
                    ...
                    success: function(data){
                    	if(data.code == "200"){
                    		$.ajax({
                        		type: "POST",
                                url: "/courseware/ignoreCoursewarePreRev.do",  
                                data: {id : PUBLIC_ID, fId : PUBLIC_FILE_ID},
                                dataType: "json",
                                success: function(data){
                                	if(data.code == "200"){
                                		alert("操作完成！");
