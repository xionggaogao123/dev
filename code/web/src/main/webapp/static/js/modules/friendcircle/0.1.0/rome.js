...
!function (e) {
    if ("object" == typeof exports && "undefined" != typeof module)module.exports = e(); else if ("function" == typeof define && define.amd)define([], e); else {
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.rome = e()
    }
}(function () {
                ...
                (function (root, undefined) {
                    ...
                    function _emitter(thing, options) {
                        ...
                        thing.emit = function () {
                            ...
                            var type = args.shift();
                            var et = evt[type];
                            if (type === 'error' && opts.throws !== false && !et) {
                            ...
                            evt[type] = et.filter(function emitter(listen) {
                                if (opts.async) {
                                    debounce(listen, args, thing);
                                } else {
                                    listen.apply(thing, args);
                                }
                                return !listen._once;
                            });
                            return thing;
 ...
 * }));
        ...
        }, {"lodash.debounce": 5, "lodash.isfunction": 8, "lodash.isobject": 9}],
 ...
 * }, false);
        ...
        }, {"lodash.isfunction": 8, "lodash.isobject": 9, "lodash.now": 6}],
        ...
        15: [function (_dereq_, module, exports) {
            ...
            function calendar(calendarOptions) {
                ...
                function eventListening(remove) {
                    ...
                    if (o.autoHideOnBlur) {
                        events[op](document, 'focusin', hideOnBlur);
                    }
                    if (o.autoHideOnClick) {
                        events[op](document, 'click', hideOnClick);
                    }
                }
...
// naïve implementation, only meant to clone `options` objects
        ...
        }, {"./index": 22, "./inline": 23, "./input": 24, "./isInput": 25}],
        ...
        24: [function (_dereq_, module, exports) {
            ...
            function inputCalendar(input, calendarOptions) {
                ...
                function eventListening(remove) {
                    ...
                    if (o.invalidate) {
                        events[op](input, 'blur', invalidateInput);
                    }
...
// maybe move to IE-specific distro?
            ...
            "./core": 18,
            "./index": 22,
            "./polyfills/array.every": 29,
            "./polyfills/array.filter": 30,
            "./polyfills/array.foreach": 31,
            "./polyfills/array.indexof": 32,
            "./polyfills/array.isarray": 33,
            "./polyfills/array.map": 34,
            "./polyfills/array.some": 35,
            "./polyfills/function.bind": 36,
            "./polyfills/string.trim": 37,
            "./use": 41,
            "./validators": 42
        }],
        ...
        }, {"./association": 14, "./index": 22, "./parse": 28}]
    }, {}, [39])
