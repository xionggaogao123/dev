...
(function (p) {
    ...
    var j = {apply: function (b, a, c) {
        ...
        b.push("<span id='", c.tId, e.id.ICON, "' title='' treeNode", e.id.ICON, " class='", i.makeNodeIcoClass(a, c), "' style='", i.makeNodeIcoStyle(a, c), "'></span><span id='", c.tId, e.id.SPAN, "' class='ellipsis' style='max-width: 9em;'>", d, "</span>")
